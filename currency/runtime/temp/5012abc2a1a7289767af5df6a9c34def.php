<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"E:\phpstudy\PHPTutorial\WWW\currency\public/../application/admin\view\Conf\ConfList.html";i:1540885301;s:75:"E:\phpstudy\PHPTutorial\WWW\currency\application\admin\view\Public\top.html";i:1572663696;s:76:"E:\phpstudy\PHPTutorial\WWW\currency\application\admin\view\Public\left.html";i:1573094587;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加系统配置" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = 'ConfAdd'"> <i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                            ...
                            <div class="widget-body">
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <?php if(is_array($Conf) || $Conf instanceof \think\Collection || $Conf instanceof \think\Paginator): $i = 0; $__LIST__ = $Conf;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ConfRes): $mod = ($i % 2 );++$i;?>
                                        <tr>
                                            <td align="center" name="cateid"><?php echo $ConfRes['cname']; ?></td>
                                            <td align="center" name="cateid"><?php echo $ConfRes['ename']; ?></td>
                                            <td align="center" name="cateid"><?php echo $ConfRes['from_type']; ?></td>
                                            <td align="center" name="cateid">
                                                <?php if($ConfRes['conf_type'] == 1): ?>店铺配置 <?php else: ?>商品配置<?php endif; ?>
                                            </td>
                                            <td align="center" name="cateid"><?php echo $ConfRes['values']; ?></td>
                                            <td align="center" name="cateid"><?php echo $ConfRes['value']; ?></td>
                                            <td align="center">
                                                <a href="<?php echo url('ConfEdit',array('id'=>$ConfRes['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>

                                                <a href="#" onClick="warning('确实要删除吗', '<?php echo url('ConfDel',array('id'=>$ConfRes['id'])); ?>')"
