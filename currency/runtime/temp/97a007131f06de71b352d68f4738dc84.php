<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"E:\phpstudy\PHPTutorial\WWW\currency\public/../application/admin\view\Admin\lisAdmin.html";i:1551166343;s:75:"E:\phpstudy\PHPTutorial\WWW\currency\application\admin\view\Public\top.html";i:1572663696;s:76:"E:\phpstudy\PHPTutorial\WWW\currency\application\admin\view\Public\left.html";i:1573094587;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Admin/addAdmin'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="10%">所属分组</th>
                                <th class="text-center" width="10%">管理员</th>
                                <th class="text-center" width="10%">邮箱</th>
                                <th class="text-center" width="20%">最后登录时间</th>
                                <th class="text-center" width="20%">最后登录IP</th>
                        ...
                        <?php if(is_array($AdminRes) || $AdminRes instanceof \think\Collection || $AdminRes instanceof \think\Paginator): $i = 0; $__LIST__ = $AdminRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center"><?php echo $admin['group']; ?></td>
                                <td align="center"><?php echo $admin['user_name']; ?></td>
                                <td align="center"><?php echo $admin['email']; ?></td>
                                <td align="center"><?php echo $admin['loginTime']; ?></td>
                                <td align="center"><?php echo $admin['loginIp']; ?></td>
                                <td align="center">
                                    <?php if($admin['isEnabled']  == 1): ?>
                                        正常
                                    <?php else: ?>
                                        禁用
                                    <?php endif; ?>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('editAdmin',array('id'=>$admin['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="<?php echo url('delAdmin',array('id'=>$admin['id'])); ?>" onClick="warning('确实要删除吗')" class="btn btn-danger btn-sm shiny">
