<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"E:\phpstudy\PHPTutorial\WWW\currency\public/../application/admin\view\Conf\Clist.html";i:1540885292;s:75:"E:\phpstudy\PHPTutorial\WWW\currency\application\admin\view\Public\top.html";i:1572663696;s:76:"E:\phpstudy\PHPTutorial\WWW\currency\application\admin\view\Public\left.html";i:1573094587;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('Conf/ConfList'); ?>">配置项管理</a>
                        </li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('Conf/Clist'); ?>" method="post" enctype="multipart/form-data" >
                        <div class="tabbable">
                            ...
                            <div class="tab-content tabs-flat no-padding">
                                ...
                                <div id="SConf" class="tab-pane padding-5 animated fadeInUp active" style="margin-top: 20px">
                                    ...
                                    <div class="form-group">
                                        <label  class="col-sm-2 control-label no-padding-right"><?php echo $SConf['cname']; ?></label>
                                        <div class="col-sm-4">
                                            <!--input类型-->
                                            <?php if($SConf['from_type'] == 'input'): ?>
                                                <input class="form-control"  placeholder="" name="<?php echo $SConf['ename']; ?>" value="<?php echo $SConf['value']; ?>"  type="text">
                                            <!--radio类型-->
                                            <?php elseif($SConf['from_type'] == 'radio'): foreach($SConf['values'] as $k => $v):?>
                                                    <div class="radio" style="float: left;margin-left: 10px">
                                                        <label>
                                                            <input <?php if($SConf['value']==$v):?><?php echo"class='inverted' checked='checked'";endif;?>  name=" <?php echo $SConf['ename']; ?>" type="radio" value="<?php echo $v; ?>" >
                                                            <span class="text"><?php echo $v; ?></span>
                                                        </label>
                                                    </div>
                                                <?php endforeach;?>
                                            <!--checked类型-->
                                            <?php elseif($SConf['from_type'] == 'checked'): if($SConf['values']):
                                                        $attr_value=explode(',',$SConf['value']);
                                                        foreach($SConf['values'] as $k => $v):
                                                        ?>
                                                    <label>
                                                        <input id="form-field-checkbox" <?php if(in_array($v,$attr_value)){echo 'checked="checked"';}?>   name="<?php echo $SConf['ename']; ?>[]" value="<?php echo $v; ?>" type="checkbox">
                                                        <span class="text"><?php echo $v; ?></span>
                                                    </label>
                                                <?php endforeach; endif;?>
                                            <!--file类型-->
                                            <?php elseif($SConf['from_type'] == 'file'): ?>
                                                <input name="<?php echo $SConf['ename']; ?>"  type="file">
                                            <!--selected类型-->
                                            <?php elseif($SConf['from_type'] == 'selected'): ?>
                                                <select name="<?php echo $SConf['ename']; ?>">
                                                    <?php if($SConf['values']):
                                                      foreach($SConf['values'] as $k1 => $v1):?>
                                                    <option <?php if($SConf['value']==$v1){echo 'selected="selected"';}?> value="<?php echo $v1; ?>"><?php echo $v1; ?></option>
                                                    <?php endforeach; endif;?>
                                                </select>
                                            <?php else: ?>
                                            <!--textarea类型-->
                                                <textarea style="resize:none; width:100%;height: 115px" name="<?php echo $SConf['ename']; ?>" ><?php echo $SConf['value']; ?></textarea>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <?php endforeach;?>
                                ...
                                <div id="Spdesc" class="tab-pane  animated fadeInUp" style="margin-top: 20px;padding-bottom: 20px">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label  class="col-sm-2 control-label no-padding-right"><?php echo $GConf['cname']; ?></label>
                                                <div class="col-sm-4">
                                                    <!--input类型-->
                                                    <?php if($GConf['from_type'] == 'input'): ?>
                                                    <input class="form-control"  placeholder="" name="<?php echo $GConf['ename']; ?>" value="<?php echo $GConf['value']; ?>"  type="text">
                                                    <!--radio类型-->
                                                    <?php elseif($GConf['from_type'] == 'radio'): foreach($GConf['values'] as $k => $v):?>
                                                    <div class="radio" style="float: left;margin-left: 10px">
                                                        <label>
                                                            <input <?php if($GConf['value']==$v):?><?php echo"class='inverted' checked='checked'";endif;?>  name=" <?php echo $GConf['ename']; ?>" type="radio" value="<?php echo $v; ?>" >
                                                            <span class="text"><?php echo $v; ?></span>
                                                        </label>
                                                    </div>
                                                    <?php endforeach;?>
                                                    <!--checked类型-->
                                                    <?php elseif($GConf['from_type'] == 'checked'): if($GConf['values']):
                                                        $attr_value=explode(',',$GConf['value']);
                                                        foreach($GConf['values'] as $k => $v):
                                                    ?>
                                                    <label>
                                                        <input  <?php if(in_array($v,$attr_value)){echo 'checked="checked"';}?>   name="<?php echo $GConf['ename']; ?>[]" value="<?php echo $v; ?>" type="checkbox">
                                                        <span class="text"><?php echo $v; ?></span>
                                                    </label>
                                                    <?php endforeach; endif;?>
                                                    <!--file类型-->
                                                    <?php elseif($GConf['from_type'] == 'file'): ?>
                                                    <input name="<?php echo $GConf['ename']; ?>"  type="file">
                                                    <!--selected类型-->
                                                    <?php elseif($GConf['from_type'] == 'selected'): ?>
                                                    <select name="<?php echo $GConf['ename']; ?>">
                                                        <?php if($GConf['values']):
                                                      foreach($GConf['values'] as $k1 => $v1):?>
                                                        <option <?php if($GConf['value']==$v1){echo 'selected="selected"';}?> value="<?php echo $v1; ?>"><?php echo $v1; ?></option>
                                                        <?php endforeach; endif;?>
                                                    </select>
                                                    <?php else: ?>
                                                    <!--textarea类型-->
                                                    <textarea style="resize:none; width:100%;height: 115px" name="<?php echo $GConf['ename']; ?>" ><?php echo $GConf['value']; ?></textarea>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <?php endforeach;?>
