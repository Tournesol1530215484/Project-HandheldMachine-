<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:94:"E:\phpstudy\PHPTutorial\WWW\currency\public/../application/admin\view\article\articlelist.html";i:1573195416;s:75:"E:\phpstudy\PHPTutorial\WWW\currency\application\admin\view\Public\top.html";i:1572663696;s:76:"E:\phpstudy\PHPTutorial\WWW\currency\application\admin\view\Public\left.html";i:1573094587;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body" >
             ...
             <form  method="post" action="<?php echo url('admin/Article/ArticleSelect'); ?>" class="form-horizontal form" enctype="multipart/form-data" class="form-inline" >
                ...
                <input type="id" class="form-control" name="select_id"  placeholder="文章id" style="width: 150px; display: inline-block;" >

                <span class="label label-sky graded" style="margin-left: 30px;padding: 11px 6px;">文章标题</span>
                <input type="name" class="form-control" name="select_title" placeholder="文章标题" style="width: 150px; display: inline-block;" >

                <span class="label label-sky graded" style="margin-left: 30px;padding: 11px 6px;">状态</span>
                
                <select name="select_isopen" class="form-control" style="width: 138px; display: inline-block;" >
                            ...
                            <div class="widget">
                                    <div class="flip-scroll">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php if(is_array($Article) || $Article instanceof \think\Collection || $Article instanceof \think\Paginator): $i = 0; $__LIST__ = $Article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ArticleRes): $mod = ($i % 2 );++$i;?>
                                                
                                            <tr>
                                                <td align="center" ><?php echo $ArticleRes['article_id']; ?></td>
                                                <td align="center"><?php echo $ArticleRes['title']; ?></td>
                                                <td align="center"><?php echo $ArticleRes['cat_name']; ?></td>
                                                <td align="center"><?php echo $ArticleRes['add_time']; ?></td>
                                                <td align="center">
                                                    <input type="" name="editArticleclick" value="<?php echo $ArticleRes['click']; ?>" style="width: 60px;">
                                                </td>
                                                 <td align="center">
                                                    <input type="" name="editArticlescort" value="<?php echo $ArticleRes['scort']; ?>" style="width: 60px;">
                                                </td>
                                               <td align="center"><?php echo $ArticleRes['article_type']; ?></td>
                                                <td align="center">
                                                    <label>
                                                        <input class="checkbox-slider toggle colored-blue flag" <?php if($ArticleRes['is_open']==1){echo 'checked="checked"';}?>   name="checled" value="<?php echo $ArticleRes['is_open']; ?>"  type="checkbox" >
                                                        <span class="text"></span>
                                                    </label>
                                                </td>
                                                <td align="center">
                                                        
                                                       <a href="<?php echo url('/admin/Index/editadmin',array('id'=>$ArticleRes['article_id'])); ?>"  class="btn btn-primary btn-sm shiny editinfo">
                                                        <i class="fa fa-edit "></i> 编辑
                                                    </a>

                                                    <a href="<?php echo url('/admin/Index/editadmin',array('id'=>$ArticleRes['article_id'])); ?>" onClick="warning('确实要删除吗', '')" class="btn btn-danger btn-sm shiny" >
...
<script type="text/javascript">
    ...
    //     // var url="<?php echo url('/admin/Article/screenArticleinfo'); ?>";
    //     //    $.ajax({
    //     //        method:'POST',
    //     //        url:url,
    //     //        data:{
    ...
    $('.flag').on('click',function() {
        ...
        var fun="editArticlestatus";
        var url="<?php echo url('/admin/Article/editArticleinfo'); ?>";
           $.ajax({
               method:'POST',
               url:url,
               data:{
