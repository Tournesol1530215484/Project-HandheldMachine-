<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:94:"E:\phpstudy\PHPTutorial\WWW\currency\public/../application/admin\view\article\Articlelist.html";i:1573316832;s:75:"E:\phpstudy\PHPTutorial\WWW\currency\application\admin\view\Public\top.html";i:1572663696;s:76:"E:\phpstudy\PHPTutorial\WWW\currency\application\admin\view\Public\left.html";i:1573094587;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body" >
             ...
             <form  method="post" action="<?php echo url('admin/Article/ArticleSelect'); ?>" class="form-horizontal form" enctype="multipart/form-data" class="form-inline" id="search-form2">
                <button type="button"  class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('/admin/Index/addadmin'); ?>'" style=" display: inline-block; padding: 8px 9px;"> <i class="fa fa-plus"></i> 添加文章</button>
                <!--添加链接结束-->
                                    ...
                                    <div class="flip-scroll">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><?php echo $ArticleRes['publish_time']; ?></td>
                                                <td align="center">
                                               ...
                                               <td align="center"><?php echo $ArticleRes['article_type']; ?></td>
                                                ...
                                                <td align="center">
                                                       ...
                                                       <a href="<?php echo url('/admin/Article/editadmin',array('id'=>$ArticleRes['article_id'])); ?>"  class="btn btn-primary btn-sm shiny editinfo">
                                                        <i class="fa fa-edit "></i> 编辑
                                                    </a>

                                                    <a href="<?php echo url('/admin/Article/editadmin',array('id'=>$ArticleRes['article_id'])); ?>" onClick="warning('确实要删除吗', '')" class="btn btn-danger btn-sm shiny" >
    ...
    $('input[name="editArticlescort"]').change(function() {
       ...
       function exportUser() {
        ...
        // $('input[name="user_ids"]').val('');
         $('#search-form2').attr('action',"<?php echo url('admin/Article/downExcel'); ?>")
        // var selected_ids = '';
