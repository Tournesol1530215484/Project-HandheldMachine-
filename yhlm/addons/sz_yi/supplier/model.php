...
if (!class_exists('SupplierModel')) {
	...
	class SupplierModel extends PluginModel
	{
		...
		{	
			...
			$_var_155 = str_replace('[时间]', date('Y-m-d H:i:s', time()), $_var_155);
			$_var_156 = array('keyword1' => array('value' => !empty($_var_152['commission_becometitle']) ? $_var_152['commission_applytitle'] : '会员申请供应商通知', 'color' => '#73a68d'), 'keyword2' => array('value' => $_var_155, 'color' => '#73a68d'));
			m('message')->sendCustomNotice($openid, $_var_156);
		}
	}
}
