...
$supplier = pdo_fetchcolumn('select id  from '.tablename('sz_yi_perm_user')." where openid = '{$openid}' and merchid = 0 and dealmerchid = 0 and type = 2 limit 1  ");  //type = 1 suppleir type = 2 merch
$merch = pdo_fetchcolumn('select id  from '.tablename('sz_yi_perm_user')." where openid = '{$openid}' and merchid > 0 limit 1  ");                     //merchid > 0 localmerch or statemerch
$barter = pdo_fetchcolumn('select id  from '.tablename('sz_yi_perm_user')." where openid = '{$openid}' and dealmerchid > 0 limit 1  ");                //dealmerchid > 0 barter
...
include $this->template('member/merch_center');