...
class Sz_DYi_Time{
    ...
    /**     * 返回本周末开始和结束的时间戳     *     * @return array     */    
    public static function endWeek()    
    {        
        $timestamp = time();        
        return [            
            strtotime(date('Y-m-d', strtotime("this week Saturday", $timestamp))),            
            strtotime(date('Y-m-d', strtotime("this week Sunday", $timestamp))) + 24 * 3600 - 1        
        ];    
    }


     /**     * 返回上周开始和结束的时间戳     *     * @return array     */    
    ...
    */    
    ...
    /**     * 返回几天前的时间戳     *     * @param int $day     * @return int     */    
    ...
    /**     * 返回几天后的时间戳     *     * @param int $day     * @return int     */    
    ...
    /**     * 天数转换成秒数     *     * @param int $day     * @return int     */    
    public static function daysToSecond($day = 1)    
    {        
        return $day * 86400;    
    }     

    /**     * 周数转换成秒数     *     * @param int $week     * @return int     */    
