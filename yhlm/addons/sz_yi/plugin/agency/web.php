...
class AgencyWeb extends Plugin
{
	public function __construct()
	{
		...
		if(!empty($_W['uid'])){
		    ...
		    if(empty($item)){
		        ...
		        $arr=array('id'=>0,'title'=>'基础设置','url'=>'./index.php?c=site&a=entry&method=merch&p=agency&do=plugin&m=sz_yi','permission_name' => 'agency_merch');
    ...
    public function bonus_for_agency(){
        $this->_exec_plugin(__FUNCTION__); 
    }
