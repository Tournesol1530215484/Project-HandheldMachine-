   ...
   if($_W['ispost'] ){ 
        ...
        if( $ac == 'get' ){ //获取修改数据
              ...
              if(!empty($goods)){
                   ...
                   $goods['option']=pdo_fetchall(' select * from '.tablename('sz_yi_goods_option').' where goodsid = :goodsid and uniacid = :uniacid',array(':goodsid'=>$goods['id'],':uniacid'=>$_W['uniacid']));
