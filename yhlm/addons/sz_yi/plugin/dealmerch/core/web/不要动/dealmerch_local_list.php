...
if ($operation == 'display') {
	ca('dealmerch.dealmerch_local_list');
	// 7天自动收货
	...
	$condition = ' o.uniacid = :uniacid and o.deleted=0 and o.isexchange = 1 and o.addressid=0 ';  
	...
	if (p('supplier')) {
		$cond = " and  o.isexchange = 1 and o.addressid=0 ";
		if ($perm_role == 1) {
	...
	if ($_GPC['debug']) {
		$mytemp=pdo_fetchall('select id from '.tablename('sz_yi_order').' where uniacid = :uniacid and isexchange = 1 and status = 1',array(':uniacid'=>$_W['uniacid']));
