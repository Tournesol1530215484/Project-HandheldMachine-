...
$tmpMember=m('member')->getMember($muser['openid']);
...
if ($op == 'display') {
    ...
    foreach ($list as $key => $value) {               
       ...
       $list[$key]['qrcode']=m('match')->createQrcode($this->createPluginMobileUrl('match/picture',array('op'=>'detail','id'=>$value['id'])));                      
    }                           
