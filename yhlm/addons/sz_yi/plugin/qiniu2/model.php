...
if (!class_exists('QiniuModel')) {
    ...
    class QiniuModel extends PluginModel
    {
        ...
        public function save($url, $config)
        {
            ...
            $upToken    ='XLTpD9g6brmqlobhg3ViXr0mluwya4y0w2fVfn36:HwYoMdLrEB7F7hSjkfsRpHJK7es=:eyJyZXR1cm5VcmwiOiJodHRwOlwvXC8xMjcuMC4wLjFcL0FsbHRlc3RcL3Fpbml1XC9maWxlaW5mby5waHAiLCJyZXR1cm5Cb2R5Ijoie1wiZm5hbWVcIjogJChmbmFtZSl9Iiwic2NvcGUiOiJ5aGxtIiwiZGVhZGxpbmUiOjE1NzEwMjkzMjd9';
