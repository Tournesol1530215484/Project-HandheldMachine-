...
// public static String CallNum(String phoneNum)
//      {
//              String ret = "";
//                 String data ="{ "+
//                      "\"calleeNum\": \""+phoneNum+"\","+
//                      "\"calleeDisplayNum\": \"07588662110\"," + 
//                      "\"voices\": [{\"loop\": \"1\",\"items\": [{\"voiceFile\": \"/voices/51827870.wav\",\"type\": \"VOICE\"}]}]"+
//                      "}";
//           ret=HttpClientUtil.sendHttpPostJson("http://58.63.214.202:81/epbx/20140301/interface/playback.json",data);

//              return ret;
//              //MessageBox.Show(ret);
//          }

//          voices={loop:1,items{voiceFile:"/voices/51827870.wav",type:"VO
//          "}}

//          voices=[loop:1,items[voices:"/voices/51827870.wav",type:"VOICE"]]