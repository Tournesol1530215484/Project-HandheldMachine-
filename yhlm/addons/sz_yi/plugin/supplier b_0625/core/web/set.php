...
$power = array(
    ...
    'suppliermenu.visit'        => '前台访问权限',
    'suppliermenu.balance'      => '允许提现到余额',
    'suppliermenu.wechat'       => '允许提现到微信',
    'suppliermenu.shelves'=>'允许上架商品',
);
// 供应商
$_power = $set['power'];
// 商家
$storepower = $set['storepower'];
...
if ($_W['ispost']){
   ...
   if(!empty($_GPC['power'])){
    ...
    $data['storepower'] = $_GPC['storepower'];
