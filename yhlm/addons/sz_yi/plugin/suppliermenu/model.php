...
if (!class_exists('SuppliermenuModel')) {
...

	{
		...
		public function getMemberLevel($id=0){

			global $_W;

			$level=pdo_fetch('select * from '.tablename('sz_yi_bart_member').' where uniacid = :uniacid and id = :id and status = 1',array(':uniacid'=>$_W['uniacid'],':id'=>$id));
