...
if ($operation == 'display') {
	...
	include $this->template('dealorder/list'); 
	...
	include $this->template('dealorder/detail');
	...
	if ($to == 'confirmpay') {
		...
		include $this->template('dealorder/changeprice');
		...
		include $this->template('dealorder/express');
	...
	include $this->template('dealorder/apply');
