        ...
        if ($list) {
            ...
            foreach ($list as $key => $value) {
                ...
                $list[$key]['thumb']=tomedia($value['thumb']);
                 ...
                 $list[$key]['mainmap']=tomedia($value['mainmap']);
    ...
    if ($ac == 'sub') {
        ...
        $data=array(         
            ...
            'thumb'     =>serialize($_GPC['post1']),
             ...
             'mainmap'     =>serialize($_GPC['post2']),      //改成了首页主图
        ...
        if ($list) {
            ...
            foreach ($list as $key => $value) {
                ...
                $list[$key]['thumb']=unserialize($value['thumb']);
                 ...
                 $list[$key]['mainmap']=unserialize($value['mainmap']);
                ...
                foreach ($list[$key]['mainmap'] as $k => $v) {

                    $list[$key]['mainmap'][$k]=tomedia($v);
    ...
    if ($_W['isajax']) {        
            ...
            foreach ($ad['goods'] as $key => $value) {
                ...
                $ad['goods'][$key]['thumb']=tomedia($value['thumb']);
                 ...
                 $ad['goods'][$key]['mainmap']=tomedia($value['mainmap']);
