...
$this->set['openorderdetail'] = m('commission')->getAuthority('show_goods', $this->set['openorderdetail'] );
//分销订单购买者详情: 分销中心分销订单是否显示购买者
$this->set['openorderbuyer']  = m('commission')->getAuthority('show_customer', $this->set['openorderbuyer'] );
...
if($_W['isajax']&&!empty($_GPC['com'])){
     echo $commissioncount;
     exit;
}
