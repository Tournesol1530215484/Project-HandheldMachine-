...
global $_W, $_GPC;
$mid     = intval($_GPC['mid']);    //获取memberid
$openid  = m('user')->getOpenid();      //获取当前用户id
$member  = m('member')->getMember($openid);
$set     = $this->set;
$uniacid = $_W['uniacid'];
//是否关闭"我的小店"功能 data2016.08.25
$closemyshop = m('commission')->getAuthority('is_shop', $set['closemyshop'] );
$set['closemyshop'] = $closemyshop;
if( !isMobile() && $this->yzShopSet['ispc']==1 || $closemyshop){
