...
if ($operation == 'display'){
    ...
    if (checksubmit('submit')){
        ...
        message('更新模板成功！', $this -> createPluginWebUrl('suppliermenu/exhelper', array('ac'=>'senduser','op' => 'display')), 'success');
    }
    ...
    if (empty($item)){
        message('抱歉，模板不存在或是已经被删除！', $this -> createPluginWebUrl('suppliermenu/exhelper', array('ac'=>'senduser','op' => 'display')), 'error');
    }
    ...
    message('设置默认成功！', $this -> createPluginWebUrl('suppliermenu/exhelper', array('ac'=>'senduser','op' => 'display')), 'success');
}
load() -> func('tpl');
include $this -> template('exhelper/senduser');
