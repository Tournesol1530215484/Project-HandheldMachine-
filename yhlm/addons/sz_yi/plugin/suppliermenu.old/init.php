...
global $_W;
        ...
        if( !pdo_fetchcolumn(' select id from '.tablename('core_menu')." where pid = $id  and title like '%商品管理%' and name = 'suppliermenu' and permission_name = 'suppliermenu_goods' limit 1 ") ){
            pdo_insert('core_menu',array('pid'=>$id,'title'=>'商品管理','name'=>'suppliermenu','is_display'=>1,'type'=>'url','url'=>$this->createPluginWebUrl('suppliermenu/goods',array(),true),'permission_name'=>'suppliermenu_goods'));    
        }
        ...
        if( !pdo_fetchcolumn(' select id from '.tablename('core_menu')." where pid = $id  and title like '%订单管理%' and name = 'suppliermenu' and permission_name = 'suppliermenu_order' limit 1 ") ){
            pdo_insert('core_menu',array('pid'=>$id,'title'=>'订单管理','name'=>'suppliermenu','is_display'=>1,'type'=>'url','url'=>$this->createPluginWebUrl('suppliermenu/order',array(),true),'permission_name'=>'suppliermenu_order')); 
        }
        ...
        if( !pdo_fetchcolumn(' select id from '.tablename('core_menu')." where pid = $id  and title like '%店铺装修%' and name = 'suppliermenu' and permission_name = 'suppliermenu_designer' limit 1 ") ){
            pdo_insert('core_menu',array('pid'=>$id,'title'=>'店铺装修','name'=>'suppliermenu','is_display'=>1,'type'=>'url','url'=>$this->createPluginWebUrl('suppliermenu/designer',array(),true),'permission_name'=>'suppliermenu_designer')); 
        }
        ...
        if( !pdo_fetchcolumn(' select id from '.tablename('core_menu')." where pid = $id  and title like '%淘宝助手%' and name = 'suppliermenu' and permission_name = 'suppliermenu_taobao' limit 1 ") ){
            pdo_insert('core_menu',array('pid'=>$id,'title'=>'淘宝助手','name'=>'suppliermenu','is_display'=>1,'type'=>'url','url'=>$this->createPluginWebUrl('suppliermenu/taobao',array(),true),'permission_name'=>'suppliermenu_taobao'));  
        }
        ...
        if( !pdo_fetchcolumn(' select id from '.tablename('core_menu')." where pid = $id  and title like '%快递助手%' and name = 'suppliermenu' and permission_name = 'suppliermenu_exhelper' limit 1 ") ){
            pdo_insert('core_menu',array('pid'=>$id,'title'=>'快递助手','name'=>'suppliermenu','is_display'=>1,'type'=>'url','url'=>$this->createPluginWebUrl('suppliermenu/exhelper',array(),true),'permission_name'=>'suppliermenu_exhelper'));   
        }
        ...
        if( !pdo_fetchcolumn(' select id from '.tablename('core_menu')." where pid = $id  and title like '%店铺入口%' and name = 'suppliermenu' and permission_name = 'suppliermenu_index' limit 1 ") ){
            pdo_insert('core_menu',array('pid'=>$id,'title'=>'店铺入口','name'=>'suppliermenu','is_display'=>1,'type'=>'url','url'=>$this->createPluginWebUrl('suppliermenu/index',array(),true),'permission_name'=>'suppliermenu_index','displayorder'=>1));   
        }
