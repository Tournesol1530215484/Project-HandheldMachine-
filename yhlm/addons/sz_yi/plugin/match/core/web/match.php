...
if ($op == 'display') {
    ...
    if ($_GPC['export'] == 1){      //导出
        ...
        plog('match.export.signup', '导出比赛选手名单');
        ...
        m('excel') -> export($list,             
            ...
            array(
                ...
                'title' =>  $list[0]['mattitle'].'比赛选手名单', 

                'columns' => array(

                    array('title' => '比赛名称', 'field' => 'mattitle', 'width' => 24), 
    ...
    if ($_GPC['export'] == 1){      //导出
        ...
        plog('match.export.statistics', '导出比赛汇总');          
    ...
    if ($ac == 'post') {
        ...
        if ($exists) {          
            ...
            show_json(0,'该用户已经报名当前比赛,无法进行后台报名!');
