...
function cascdeInit(v1,v2,v3) {
    ...
    var dropElement1 = document.getElementById("s-provance");
    var dropElement2 = document.getElementById("s-city");
    var dropElement3 = document.getElementById("s-area");
...
function selCity() {
    ...
    var province = document.getElementById("s-city");
    var city = document.getElementById("s-area");
