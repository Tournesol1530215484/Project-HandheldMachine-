...
//获取xml文件
function cascdeInit(v1,v2,v3,provance,city,area) {
    //打开xlmdocm文档
    xmlDoc = loadXmlFile('../addons/sz_yi/static/js/dist/area/Area.xml?v=3');
    var dropElement1 = document.getElementById(provance);
    var dropElement2 = document.getElementById(city);
    var dropElement3 = document.getElementById(area);
...
//设置县,区
*/
function selectcounty(v3,provance,city) {
