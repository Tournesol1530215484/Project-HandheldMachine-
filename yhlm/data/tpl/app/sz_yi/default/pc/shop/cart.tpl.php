...
.cart_top {height:44px; width:100%;  background:#e8e8e8;  border-bottom:1px solid #e3e3e3;}
...
.cart_good {height:80px;  padding:10px 0px; border-bottom:1px solid #e3e3e3;box-sizing: content-box;}
...
.cart_good .other .num .leftnav {height:26px; width:25px; float:left; border-right:1px solid #e2e2e2; background:#eee; color:#6b6b6b; text-align:center; line-height:24px; font-size:20px; font-weight:bold;}
.cart_good .other .num .shownum {height:26px; width:26px; float:left; border:0px; margin:0px; padding:0px; text-align:center;}
.cart_good .other .num .rightnav {height:26px; width:25px; float:right; border-left:1px solid #e2e2e2; background:#eee; color:#6b6b6b; text-align:center; line-height:24px; font-size:20px; font-weight:bold;}

.cart_pay {float:left;height:54px; width:100%; padding: 0 1%; background:#E8E8E8; border-top:1px solid #e1e1e1;
    bottom: 0;left:0px;
...
.cart_count {height:40px; padding:0 3px; text-align:right; color:#313131; font-size:14px; line-height:40px;}
.cart_count span {color:#313131;}
...
.info{top: 0 !important}
.good_choose .other{margin-top: 0!important}
.good_choose .sub{position: static!important;}
.good_choose .info .right{top: 10px!important;}
.good_choose .info .left{margin-top: 10px}
.good_choose{   position: fixed;
    width: 500px;
    min-height: 280px;
    left: 50%;
    top: 20%;
...
<div class="cart_top">
    ...
    <div class="cart_pay">
        ...
        <div class="text">合计：<span>￥<span  class='totalprice'><%totalprice%></span></span><br><span style="color:#313131; font-size:14px;">不含运费</span></div>
    </div>
</script>
