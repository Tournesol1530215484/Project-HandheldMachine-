...
.good_info1 .info1 {height:80px; width:100%; border-bottom:1px dashed #f3f3f3; padding:20px 0px;}
...
.good_shop {height:118px; width:100%; background:#fff; padding:0px 1%; margin-top:14px; border-bottom:1px solid #e2e2e2;}
.good_shop .shop1 {height:70px; width:100%; padding:10px 0px; }
...
.good_shop .shop2 {height:59px; width:100%;}
...
.good_info2 .menu .nav {height:37px; width:25%;  float:left; font-size:14px; color:#666; text-align:center; line-height:37px; border-bottom:2px solid #e3e3e3;cursor: pointer;}
.good_info2 .menu .navon {color:#ff6500; height:37px; line-height:37px; border-bottom:2px solid #ff6500; }
.good_info2 .tab_con {height:auto; width:100%; padding:10px; overflow: hidden;}
...
#recommand_container .good {height:auto; width:295px; padding:10px; float:left;box-sizing: border-box;}
#recommand_container .good img {height:295px; width:100%;}
...
<div style="display:block;overflow:hidden;width: 1200px;background-color: #fff;">
    <div class="good_img" >
        <%if pics.length>1%>
    ...
    <div class="good_info1">
        ...
        <%/if%> 
             ...
             <div class="other">
                ...
                <%each level1 as li%>
                    <i class='fa fa-user'></i> <%li.levelname%><span style='color:#ff6600'>
                      <%if goods.minprice !=goods.maxprice%>
                        (<%goods.minprice* li.discount* 10/100 %> - <%goods.maxprice* li.discount* 10/100 %>)
                        <%else%>
                        <%li.realprice%>
                    <%/if%> 
                </span> 元
  ...
  <!--  <div class="good_choose_layer"></div>-->
    <div class="good_choose" style="display:block">
        ...
        <div class="other">
                ...
                <%each specs as spec%>
                <input type='hidden' id="optionid" name="optionid[]" class='optionid optionid_<%spec.id%>' value="" title="<%spec.title%>">
                <div class="list-bor">
