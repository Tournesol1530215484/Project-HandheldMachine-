...
.cart_top .nav { width: auto; padding: 0px 10px; float: right; color: #666; font-size: 14px; margin-top: 11px; }
.cart_main { height:auto; }

.cart_good { height: 100px; padding: 10px 0px; /*border-bottom: 5px solid #fff;*/ background: #efefef; margin-bottom: 10px; }
.cart_good .ico {height:20px; width:30px; text-align: center; margin-top:25px; float:left;font-size:24px;z-index:2;position: relative;margin-right: 2px;}
.cart_good .img {height:80px; width:80px; background:#dedede; float:left;z-index:88;z-index:2;position: relative;}
.cart_good .img img {height:100%; width:100%}
.cart_good .info {position: relative;margin-left:120px;padding: 0 2%;}
.cart_good .info .name {width:100%; line-height:20px; color:#666;  font-size:12px;overflow:hidden}
.cart_good .info .inner .optionsel {height:30px; float:left; line-height:30px; font-size:14px; color:#999;}
...
.cart_good .other { z-index: 2; position: relative; margin-left: 120px;overflow: hidden;padding: 0 2%;margin-top: 5px}
.cart_good .other .price{color:#666;font-size:14px;float: left;}
.cart_good .other .num {height:30px; width:80px; border:1px solid #e2e2e2;float: right;}
...
.cart_good .other .num .shownum {height:28px; width:28px; float:left; border:0px; margin:0px; padding:0px; text-align:center;}
...
.cart_pay {float:left;height:54px; width:100%; padding: 0 3%; background:#eee; border-top:1px solid #e1e1e1; position:fixed; bottom:0px; left:0px; z-index: 9999;}
.cart_pay .all {height:54px; width:100px;  float:left; line-height:50px; font-size:14px; color:#999; }
.cart_pay .all i { font-size:24px;float:left;}
...
.card_no {height:100px;  margin:50px 0px 80px; color:#ccc; font-size:12px; text-align:center;}
.card_no_menu {height:40px; width:100%;}
.card_no_nav {height:38px; width:43%; background:#00c1ff; margin:0px 3%; float:left; border:1px solid #00c1ff; border-radius:5px; text-align:center; line-height:38px; color:#eee;}
...
<script id='option_info' type='text/html'>
 ...
 <div class="card_no"><i class="hs hs-cart" style="font-size:80px;"></i><br><span style="line-height:18px; font-size:16px;">购物车快饿瘪了</span><br>主人快去给我找点东西吧</div>
...
<div class="cart_top">
    <div class="title" onclick='history.back()'><i class='fa fa-chevron-left'></i> 购物车(<%total%>)</div>
        <div class="nav" id='tofavorite' style="border-left: 1px solid #c7c7c7;">移至收藏夹</div>
    ...
    <div class="cart_main">
          <%each list as value%>
             <div class="cart_good" 
                 ...
                 <div class="ico"><i class="hs hs-xuanzhong" style="color:#00c1ff;"></i></div><!-- fa fa-check-circle-o -->
                  ...
                  <div class="other">
                      <div class="price">
                        <%if value.optionid!='0'%>
                         <div class="optionsel">
                            <div class='content'>
                                <div class="cinner" style="color:#949494">规格：<%if optiontitle!=''%><%value.optiontitle%><%else%>未选规格<%/if%></div>
                            </div>
                            <!-- <div class="cico"><i class="fa fa-angle-down"></i></div> -->
                        </div>
                        <%/if%>
                        <span style="color:#e43a3d">¥<%value.marketprice%></span>
                        <del style="margin-left:10px;color:#949494">¥<%value.productprice%></del>
                      </div>
    ...
    <div class="cart_pay">
        <div class="all" sel="1"><i class="hs hs-xuanzhong" style="color:#00c1ff;"></i> <span class='t'>全选</span></div>
...
<script language="javascript">
    ...
    function setSelect(obj, sel,isall){
            if(sel=='1'){
                         obj.find('i').addClass('hs-wei').removeClass('hs-xuanzhong').css('color', '#999');
                    }
                    else{
