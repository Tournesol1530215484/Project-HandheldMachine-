...
<script id="my_cash" type="text/html">
	<div class="page_topbar" id="topbar-id">
		...
		<div class="title">我的现金</div>
		<a href="javascript:void(0);" class="descript-link" id="descript-link-id" onClick="showdescription()">现金说明</a>
	</div>
	<div class="balance-whole-box">
		<div class="balance-num">现金余额
	...
	<ul class="balance-part-box">  
		<!--现金充值记录-->
	    <li class="list1"> <a href="<?php  echo $this->createMobileUrl('barter/cash',array('op'=>'detail','ac'=>'recharge'))?>" class="go-link">现金充值记录<i class="fa fa-angle-right trun-right" style="font-size:26px; line-height:44px;float: right;"></i><span class="balance-value">￥<%if info.total.recharge%><%info.total.recharge%><%else%>0<%/if%></span></a></li> 
		<!--提现记录-->
...
<script language="javascript">
    ...
    require(['tpl', 'core'], function(tpl, core) {
        core.json('barter/cash',{op:'get'},function(json){
            if (json.result) {
        ...
        function withdraw(){
        	core.json('member/withdraw', {}, function (json) {
	            ...
	            //提现手续费比例 内置标签获取 同上
	            var withdrawrate = <?php  echo $ratio;?>;
