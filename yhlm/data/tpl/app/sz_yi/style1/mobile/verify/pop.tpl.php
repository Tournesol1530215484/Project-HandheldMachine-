<?php defined('IN_IA') or exit('Access Denied');?><style type="text/css">
    ...
    .verify img { width:250px!important;height:250px!important; position:absolute; top:100px; left:50%;margin-left:-125px;}
    ...
    .verify .btn {position:absolute;padding:5px;width:220px; left:50%;margin-left:-110px; top: 420px;   height:30px;  background:#f49c06; border-radius:4px; text-align:center; font-size:14px; line-height:20px; color:#fff;}
...
<div id='cover' >
    <div class="verify">
        ...
        <div class="verify_qrcode" >
            <img src="../addons/sz_yi/template/mobile/default/static/images/qrloading.jpg" />
    ...
    var VerifyHandler = {
         ...
         verify:function(orderid){
                require(['tpl', 'core'], function(tpl, core) {
                       ...
                       core.pjson('verify/qrcode',{id:orderid},function(json){
                             if(json.status==0){
                ...
                require(['tpl', 'core'], function(tpl, core) {
                core.pjson('verify/check',{id:orderid},function(json){
                      if(json.status==0){
                          return; 
                      }
                      clearInterval( VerifyHandler.verifytimer);
                      core.message('扫描核销完成!',"<?php  echo $this->createMobileUrl('order/detail',array('id'=>$_GPC['id']))?>",'success');
                },false,true);
            });
         },close:function(){
