...
.refund_main {height:auto;width:100%; padding:0px 3%; border-bottom:1px solid #f0f0f0; border-top:1px solid #f0f0f0; margin-top:14px; background:#fff;}
.refund_main .line {height:44px; width:100%; border-bottom:1px solid #f0f0f0; line-height:44px;}

.refund_main .line .label { float:left;width:70px; color: #000;height: 44px;line-height: 44px;}
...
.refund_main .line input {float:left; height:43px; width:100%; padding:0px; margin:0px; border:0px; outline:none; font-size:16px; color:#666;padding-left:5px;}
.refund_main .line select  {float:left; border:none;height:25px;line-height:25px;width:100%;color:#666;font-size:16px;margin-top:10px;}
