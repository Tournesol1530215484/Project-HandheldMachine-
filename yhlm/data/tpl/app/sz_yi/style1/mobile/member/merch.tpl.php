...
<html lang="en" class="am-touch js cssanimations">
	<head>
		...
		<link 7rel="stylesheet" type="text/css" href="../addons/sz_yi/template/mobile/default/member/merch/css/minirefresh.min.css" />
			...
			<div data-am-widget="slider" style="margin-top:45px;" class="am-slider am-slider-a1 am-no-layout" data-am-slider="{&quot;directionNav&quot;:false}">
				<div class="am-viewport" style="overflow: hidden; position: relative;">
					<ul class="am-slides" style="width: 1200%; transition-duration: 0s; transform: translate3d(-375px, 0px, 0px);">
						<?php  if(is_array($set['shop']['thumbs'])) { foreach($set['shop']['thumbs'] as $v) { ?>

						<li data-thumb-alt="" style="width: 375px; margin-right: 0px; float: left; display: block;" class="">
							<a href="<?php  echo $set['shop']['adlink'];?>">
			...
			<div style="border-bottom: 8px solid #eee;line-height:20px;color:#2bb8aa;font-size:14px;">
				...
				<div style="margin-left: 35px;">
					<marquee scrollamount="3" width="100%" style="margin-top:6px;">
						<?php  echo $set['shop']['title'];?>
					</marquee>
				</div>
			</div>
			<div class="nav-con">
				<ul>
					<?php  if(is_array($type)) { foreach($type as $v) { ?>
					<!-- <a href="javascript:type(<?php  echo $v['id'];?>);"> -->
					<a href="javascript:void(0);">
						<li class="type-item" data-typeid="<?php  echo $v['id'];?>">
				...
				$.ajax({
					...
					success: function(data) {
						...
						for(var i = 0; i < arrLen; i++) {
							...
							result += "<a class='company-link' href='" + data.result.list[i].url + "'>" +
		...
		<!--	footer-navB  -->
			  <div data-am-widget="navbar" class="am-navbar am-cf am-navbar-default "
			      ...
			      <ul class="am-navbar-nav am-cf am-avg-sm-4" style="background:#00d3be;">
			          ...
			          <li >
			            <a href="<?php  echo $this->createPluginMobileUrl('activity/activity')?>" class="" style="color: #fff">
