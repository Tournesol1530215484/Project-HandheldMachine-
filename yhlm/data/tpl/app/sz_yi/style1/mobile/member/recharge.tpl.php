...
.balance_sub1 {height:44px; margin:5%; background:#00c1ff; border-radius:4px; text-align:center; font-size:16px; line-height:44px; color:#fff;}
.with {display:block;height:44px; margin:5%; background:#c40000; border-radius:4px; text-align:center; font-size:16px; line-height:44px; color:#fff;}
.balance_sub2 {height:44px; margin:5%; background:#f49c06; border-radius:4px; text-align:center; font-size:16px; line-height:44px; color:#fff;}
.balance_sub10 {height:44px; margin:5%; background:#F60; border-radius:4px; text-align:center; font-size:16px; line-height:44px; color:#fff;}
.balance_sub3 {height:44px; margin:5%;background:#e2cb04; border-radius:4px; text-align:center; font-size:16px; line-height:44px; color:#fff;}
...
<input type="hidden" id="logid" value="<%logid%>" />
   ...
   <a class="button with" href="<?php  echo $this->createMobileUrl('member/withdraw')?>">去提现</a>
