...
<style type="text/css">
    ...
    .info_main .line .inner input {height: 39px;/*40px;*/ width:100%;display:block; padding:0px; margin:0px; border:0px; float:left; font-size:16px;}
...
<script id="member_info" type="text/html">
    ...
    <div class="info_main">
        <div class="line"><div class="title">手机号码</div><div class='info'><div class='inner clearfloat'><input type="text" id='mobile' placeholder="请输入您的手机号码"  value="" /></div></div></div>
        <div class="line"><div class="title">密码</div><div class='info'><div class='inner clearfloat'><input type="password" id='password' placeholder="请输入您的密码"  value="" /></div></div></div>
	...
	<?php  if(is_app()) { ?>
    <div class="info-wei">
      <!--i class="fa fa-weixin icon-weixin"></i-->
      <div class="info_sub info_sub_wei">微信登录</div>
    </div> 
      <?php  } ?>
    <div class="register">注册</div>       

    <div class="download android" style="float:left;margin-left: 15px;">
      <a href="../addons/sz_yi/cert/yhlm.apk">安卓APP</a>
    </div>

    <div class="download iosapp" style="float: left;margin-left: 35px;">
      <a href="https://copy.im/a/rvYRoj">IOS APP</a>
    </div>
