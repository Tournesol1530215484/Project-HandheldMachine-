...
<style type="text/css">
	...
	.tooltipbox{background:#fef8dd;border:1px solid #c40808; position:absolute; left:0;top:0; text-align:center;height:20px;color:#c40808;padding:2px 5px 1px 5px;border-radius:3px;z-index:1000;}
	.red { float:left;color:red}
</style> 
...
<header class="bg-dark dk header navbar navbar-fixed-top-xs ">
  	<style type="text/css">
  		@media (max-width: 767px){
  			.navbar_header{ width: 100%!important; }
  			.navbar_header a{ display: inline-block; }
  			.visible_xs1{ float: left; }
  			.visible_xs2{ top:0px; float: right; left: 86%!important; }
  			.nav_box{ position: relative; top: 0px; left: 0px; width: 170px!important; }
  			.navbar_right{ margin-top: -50px; height: 50px!important; line-height: 50px!important; float: right; margin-right: 20px; }
  		}
  	</style>
	<div class="navbar-header aside-md navbar_header" style="width:190px"> 
		<a class="btn btn-link visible-xs visible_xs1" data-toggle="class:nav-off-screen" data-target="#nav"><i class="fa fa-bars"></i> </a> 
		<div class="nav-box nav_box">
				...
				<div class="account-area">
					<div class="dropdown">
						<a data-toggle="dropdown" class="btn btn-link dropdown-toggle  navbarv2-left" href="javascript:;" style="color:#FFF">
							<i class="fa fa-home"></i> <?php  echo $_W['account']['name'];?><b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="javascript:;">
                                    ...
                                    <i title="编辑当前账号资料" onclick="window.parent.location='<?php  echo url('account/post', array('uniacid' => $_W['uniacid']));?>'" class="fa fa-pencil"></i>
                                    <?php  } ?>
                                </a>
                            </li>
                    	</ul>
        ...
        <a class="btn btn-link visible-xs visible_xs2" data-toggle="dropdown" data-target=".nav-user"> <i class="fa fa-cog"></i></a> 
	</div>      
    ...
    <ul class="nav navbar-nav hidden-xs">
        ...
        <?php  if(empty($_W['is_sz_yi_supplier'])) { ?>
    ...
    <?php  } ?> 
    <ul class="navbar-right navbar_right">
...
<!--    <li class="dropdown">
        ...
        <li class="dropdown topbar-notice2">
        	...
        	<ul class="dropdown-menu">
                ...
                <li><a href="<?php  echo url('home/welcome/platform');?>" target="mainFrame"><i class="fa fa-share fa-fw"></i><?php  echo $_W['account']['name'];?></a></li>
                <?php  } ?>
					...
					<div class="btn-group">
              			...
              			<div class="btn-group hidden-nav-xs">
                			...
                			<ul class="dropdown-menu text-left">
                    			<li><a href="<?php  echo url('platform/reply', array('m' => 'userapi'))?>"><i class="fa fa-sitemap"></i><span>自定义接口</span></a></li>
								...
								<li><a href="<?php  echo $shortcut_sc['link'];?>" title="<?php  echo $shortcut_sc['title'];?>">
                                    ...
                                    <span><?php  echo $shortcut_sc['title'];?></span></a>
                                </li>
								<?php  } } ?>
          		...
          		<section class="w-f scrollable" style="top:0px">
            		<div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333"> 
              			<nav class="nav-primary hidden-xs">
                			<ul class="nav">
                                ...
                                <?php  if($_W['isdealmerch']) { ?> 
                                    <?php  if($_W['isdealmerch'] && $_W['isdealmerch'] == 2 && $frame['title'] == '店铺管理') { ?>  
                                        <?php  continue;?>     
                                    <?php  } else if($_W['isdealmerch'] && $_W['isdealmerch'] == 1) { ?> 
                                        <?php  if($frame['title'] == '换货商家管理'  ||  $frame['title'] == '换货商品管理' ||  $frame['title'] == '商家投广告' ||  $frame['title'] == '换货订单管理') { ?>    
                                            <?php  continue;?>
                                        <?php  } ?>       
                                    <?php  } ?>  
                                <?php  } ?>    
                                ...
                                <?php  if($frame['title'] == '比赛管理' || $frame['title'] == '图片管理') { ?>  
                                    <?php  if($_W['uid'] != "836") { ?>
                                        <?php  continue;?>     
                                    <?php  } ?>    
                                <?php  } ?>                                             
                                 ...
                                 <li class="nav-<?php  echo $c;?>">
                                    <a href="#layout" > 
                                    	<!--<i class="fa fa-columns icon"><b class="bg-<?php  echo $bgs[$c]?>"></b></i>-->
                                    ...
                                    <ul class="nav lt">
                        				...
                        				<li class="<?php  echo $link['active'];?>">
                                        	<a href="<?php  echo $link['url'];?>" class='pull-left' style='display: block;width:86%'><i class="fa fa-angle-right"></i><span><?php  echo $link['title'];?></span></a><a href="<?php  echo $link['append']['url'];?>" class="pull-left" style="display:block;width:14%;height:43px;padding:5px;padding-right:10px;padding-top:10px;"/><?php  echo $link['append']['title'];?></a>
                    ...
                    <footer class="footer lt hidden-xs b-t b-light">                    
                        ...
                        <div class="copyright hidden-nav-xs">
                            2016 &copy; 网络科技<?php  echo $_W['page']['copyright']['sitename'];?>
                        </div>
                    </footer>
        		</section>
      		</aside>
