...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
            ...
            <input type="hidden" name="method" value="merchant" />
            <input type="hidden" name="op" value="display" />
            <div class="form-group">				<div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
	                <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">会员信息</label>
	                <div class="col-sm-8 col-lg-9 col-xs-12">
	                    <input type="text" class="form-control"  name="uid" value="<?php  echo $_GPC['uid'];?>" placeholder='搜索商家ID'/>
	                </div>
	            </div>
...
<div class="panel panel-default">
	<div class="panel-body">
    	<a class='btn btn-default' style="background-color: #1E95C9; color: #fff; border-radius: 6px;" href="<?php  echo $this->createPluginWebUrl('merchant/merchant_add', array('op' => 'post'))?>">添加新商家</a>
	</div>
</div>
<div class="panel panel-default">
                ...
                <?php  if(is_array($list)) { foreach($list as $row) { ?>
                	<?php  if(!empty($row['uid'])) { ?>
		                <tr><td><?php  echo $row['uid'];?></td>
		                    <td><a href="<?php  echo $this->createPluginWebUrl('merchant/merchant/detail',array('uid' => $row['uid']));?>" title='商家信息' style="color: #0060DF;"><?php  echo $row['username'];?></a></td>
                                ...
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="javascript:;">操作 <span class="caret"></span></a>
                                        <ul class="dropdown-menu dropdown-menu-left" role="menu" style='z-index: 99999'>
                                            <li><a href="<?php  echo $this->createPluginWebUrl('merchant/merchant/detail',array('uid' => $row['uid']));?>" title='商家信息'><i class='fa fa-user'></i> 商家信息</a></li>
                                            <li><a href="<?php  echo $this->createPluginWebUrl('merchant/merchant_add', array('op' => 'post', 'id' => $row['id']))?>" title='修改密码'><i class='fa fa-edit'></i> 修改密码</a></li>
                                            <li><a  href="<?php  echo $this->createPluginWebUrl('merchant/merchant_list',array('merchant_uid' => $row['uid']));?>" title='我的订单'><i class='fa fa-list'></i> 我的订单</a></li>
                                            <li><a href="<?php  echo $this->createPluginWebUrl('merchant/merchant_add', array('op' => 'delete', 'id' => $row['id']))?>" title="删除" onclick="return confirm('确定要删除该商家吗？');"><i class='fa fa-remove'></i> &nbsp;删除商家</a></li>
                                        </ul>
                                </div>
		                    </td>
		                </tr>
...
<form <?php if(cv('commission.merchant.edit|commission.merchant.check')) { ?>action="" method='post'<?php  } ?> class='form-horizontal'>
    <input type="hidden" name="id" value="<?php  echo $merchantinfo['uid'];?>">
