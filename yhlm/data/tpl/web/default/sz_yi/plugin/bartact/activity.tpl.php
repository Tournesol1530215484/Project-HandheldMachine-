            ...
            <div class='panel-body'>
				...
				<div class='panel panel-default' style="border-radius: 5px;">
					...
					<div class='panel-body diyform'> 	
						...
						<!-- <div class="form-group">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<label class="col-xs-12 col-sm-3 col-md-3 control-label">微信号</label>
								<div class="col-sm-9 col-xs-12">
									<input type="" class="form-control" name="wechat">
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<div class='panel-body'>
						...
						<div class="form-group">
								...
								<div class="col-sm-9 col-xs-12 diy-option" style="border:1px solid #ccc;padding-left:6%;padding-bottom:5%;">
							...
							<div class="form-group">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<div class="col-sm-9 col-xs-12">
										<?php if( ce('activity.activity' ,$su_info) ) { ?>
											<label class="radio-inline">
											  <input type="radio" name="orther[public]" <?php  if($activity['public'] == 1) { ?>checked<?php  } ?> id="inlineRadio1" value="1"> 公开     
											</label> 
											<label class="radio-inline">
											  <input type="radio" name="orther[public]" <?php  if($activity['public'] == 0) { ?>checked<?php  } ?> id="inlineRadio1" value="0"> 不公开     
											</label> 
										<?php  } else { ?>
											<div class='form-control-static'>********</div>
										<?php  } ?>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<div class="col-sm-9 col-xs-12">
										<?php if( ce('activity.activity' ,$su_info) ) { ?>
											...
											<label class="radio-inline">
											  <input type="radio" name="orther[teamModel]" <?php  if($activity['teamModel'] == 1) { ?>checked<?php  } ?> checked id="inlineRadio1" value="1"> 是      	
											</label> 
										...
										<div class="col-md-2 col-lg-5 font-set col-lg-offset-3 teamModelSet" style="margin-top:15px">
				...
				<div class='panel panel-default' style="border-radius: 5px;">
    		        <div class='panel-heading' style="background: #eee;">活动详情</div>
	        		    <div class='panel-body'>
	        		    	...
	        		    	<div class="form-group">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<label class="col-xs-12 col-sm-3 col-md-3 control-label"><span style='color:red'>*</span>活动详情</label>
									<div class="col-sm-9 col-xs-12">
										<?php if( ce('activity.activity' ,$su_info) ) { ?>
				...
				<div class='panel panel-default' style="border-radius: 5px;">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                         <?php if( ce('activity.activity' ,$su_info) ) { ?>
                        <input type="hidden" name="openid" value="<?php  echo $activity['openid'];?>" />
            ...
            <div class='panel-body'>
	            ...
	            <div class="form-group">
                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	                    ...
	                    <div class="col-sm-9 col-xs-12">
	                        <?php if( ce('activity.activity' ,$su_info) ) { ?>
	                        <input disabled="true" type="text" name="data[title]" class="form-control" value="<?php  echo $activity['title'];?>" autocomplete="off" />
	                        <?php  } else { ?> 		 
	                        <div class='form-control-static'>********</div>
	                        <?php  } ?>
	                    </div>
				...
				<div class="form-group">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="col-sm-9 col-xs-12">
							...
							<div class="checkbox">
							  <label>
							    <input disabled="true" type="checkbox" name="data[afterTheStart]" value="1" <?php  if($activity['afterTheStart']) { ?>checked<?php  } ?>>
							    开始后不允许报名
							  </label>
							</div>
							<?php  } else { ?>
				...
				<div class="form-group">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="col-sm-9 col-xs-12">	 		
							<?php if( ce('activity.activity' ,$su_info) ) { ?>
							<input disabled="true" type="text" name="data[address]" class="form-control" value="<?php  echo $activity['address'];?>" autocomplete="off" />
							<?php  } else { ?>
							<div class='form-control-static'>********</div>
							<?php  } ?>
						</div>
				...
				<div class="form-group">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="col-sm-9 col-xs-12">
							<?php if( ce('activity.activity' ,$su_info) ) { ?>
								<input disabled="true" type="text" name="data[desc]" class="form-control"  value="<?php  echo $activity['desc'];?>">
							<?php  } else { ?>
								<div class='form-control-static'>********</div>
							<?php  } ?>
						</div>
				...
				<div class="form-group">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="col-sm-9 col-xs-12">
							<?php if( ce('activity.activity' ,$su_info) ) { ?>
								<label class="radio-inline">
								  <input disabled="true" type="radio" name="data[cost]" onclick="return hidewindow();" <?php  if($activity['cost'] == 0) { ?>checked<?php  } ?> id="inlineRadio1" value="0"> 免费     
								</label> 		 
								<label class="radio-inline">
								  <input disabled="true" type="radio" name="data[cost]" onclick="return hidewindow();" <?php  if($activity['cost'] == 3) { ?>checked<?php  } ?> id="inlineRadio4" value="3"> 现场收费
								</label>
								<label class="radio-inline">
								  <input disabled="true" type="radio" name="data[cost]" onclick="return showwindow();" <?php  if($activity['cost'] == 1) { ?>checked<?php  } ?> id="inlineRadio2" value="1"> 在线支付     
								</label>
								<label class="radio-inline">
								  <input disabled="true" type="radio" name="data[cost]" onclick="return hidewindow();" <?php  if($activity['cost'] == 2) { ?>checked<?php  } ?> id="inlineRadio3" value="2"> AA制 
								</label>
							<?php  } else { ?>
								<div class='form-control-static'>********</div>
							<?php  } ?>
						...
						<div class="col-sm-9 col-xs-12">
							<table class="table table-hover table-responsive">
								...
								<tbody class="payitem">
									<?php  if(is_array($activity['payitem'])) { foreach($activity['payitem'] as $k => $v) { ?>
										<tr> 	 	  	 		 	 	 	 				 
											<td><input disabled="true" class="form-control" type="" name="payitem[<?php  echo $k;?>][title]" placeholder="项目名称" value="<?php  echo $v['title'];?>"></td>
											<td><input disabled="true" class="form-control" type="" name="payitem[<?php  echo $k;?>][limit]" placeholder="人数限制" value="<?php  echo $v['limit'];?>"></td>
											<td><input disabled="true" class="form-control" type="" name="payitem[<?php  echo $k;?>][money]" placeholder="价格" value="<?php  echo $v['money'];?>"></td>	 	 		 	  			 	  		 
											<td>
												<!-- <span class="fa fa-gear" style="float: left;"></span> -->
												<?php  if(false) { ?>
													<span class="fa fa-trash" data-id="$v['id']"><input disabled="true" type="hidden" value="<?php  echo $v['id'];?>" name="payitem[<?php  echo $k;?>][id]"></span> 	 	 		 	 		 	 	 	 	 		 
												<?php  } ?>	
											</td> 		 
										</tr>	 	 
									<?php  } } ?>	 	 
							...
							<div class="col-sm-9 col-xs-12">
							<div class="btn btn-primary" disabled="true" onclick="return additem();">添加项目</div>
								<br>
								<br>
								<label class="radio-inline"> 	 	
								  <input disabled="true" type="radio" name="data[paytype]" <?php  if($activity['paytype'] == 0) { ?>checked<?php  } ?> id="inlineRadio1" value="0"> 现场收费   	     
								</label> 		  	 	
								<label class="radio-inline">
								  <input disabled="true" type="radio" name="data[paytype]" <?php  if($activity['paytype'] == 1) { ?>checked<?php  } ?> id="inlineRadio2" value="1"> 在线支付     
								</label>
							</div>
						</div>
					</div>
					...
					<div class='panel-body'>
						...
						<div class="form-group">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								...
								<div class="col-sm-9 col-xs-12">
									<?php if( ce('activity.activity' ,$su_info) ) { ?>
										<input disabled="true" type="text" name="relOrg" value="<?php  echo $info['orgName'];?>" disabled class="form-control">
									<?php  } else { ?>
										<div class='form-control-static'>********</div>
									<?php  } ?>
								</div>
						...
						<div class="form-group">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								...
								<div class="col-sm-9 col-xs-12">
									<?php if( ce('activity.activity' ,$su_info) ) { ?>
										<input disabled="true" type="text" name="contactOrg" value="<?php  echo $info['realname'];?>" disabled class="form-control">
									<?php  } else { ?>
										<div class='form-control-static'>********</div>
									<?php  } ?>
								</div>
						...
						<div class="form-group">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								...
								<div class="col-sm-9 col-xs-12">
									<?php if( ce('activity.activity' ,$su_info) ) { ?>
										<input disabled="true" type="text" name="mobileOrg" value="<?php  echo $info['mobile'];?>" disabled class="form-control">
									<?php  } else { ?>
										<div class='form-control-static'>********</div>
									<?php  } ?>
								</div>
					...
					<div class='panel-body diyform'> 	
						...
						<!-- <div class="form-group">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<label class="col-xs-12 col-sm-3 col-md-3 control-label">微信号</label>
								<div class="col-sm-9 col-xs-12">
									<input disabled="true" type="" class="form-control" name="wechat">
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<label class="col-xs-12 col-sm-2 col-md-2 control-label" style="margin-left: -75px;">
								<input disabled="true" type="checkbox" class="" name="must">
									必填
								</label>
							</div>
						</div> --> 		
							...
							<div class="form-group">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<div class="col-sm-9 col-xs-12">
										<?php if( ce('activity.activity' ,$su_info) ) { ?>
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[joinModel]" <?php  if(empty($activity['joinModel'])) { ?>checked<?php  } ?> id="inlineRadio1" value="0"> 报名模式     
											</label> 
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[joinModel]" <?php  if($activity['joinModel'] == 1) { ?>checked<?php  } ?> id="inlineRadio1" value="1"> 邀约模式     
											</label> 
										<?php  } else { ?>  	
											<div class='form-control-static'>********</div>
										<?php  } ?>
							...
							<div class="form-group">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<div class="col-sm-9 col-xs-12">
										<?php if( ce('activity.activity' ,$su_info) ) { ?>
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[public]" <?php  if($activity['public'] == 1) { ?>checked<?php  } ?> id="inlineRadio1" value="1"> 公开     
											</label> 
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[public]" <?php  if($activity['public'] == 0) { ?>checked<?php  } ?> id="inlineRadio1" value="0"> 不公开     
											</label> 
										<?php  } else { ?>
											<div class='form-control-static'>********</div>
										<?php  } ?>
							...
							<div class="form-group">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<div class="col-sm-9 col-xs-12">
										<?php if( ce('activity.activity' ,$su_info) ) { ?>
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[hideList]" <?php  if($activity['hideList'] == 0) { ?>checked<?php  } ?> checked id="inlineRadio1" value="0"> 否     
											</label> 
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[hideList]" <?php  if($activity['hideList'] == 1) { ?>checked<?php  } ?> id="inlineRadio1" value="1"> 是     
											</label> 
										<?php  } else { ?>
											<div class='form-control-static'>********</div>
										<?php  } ?>
							...
							<div class="form-group">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<div class="col-sm-9 col-xs-12">
										<?php if( ce('activity.activity' ,$su_info) ) { ?>
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[teamModel]" <?php  if($activity['teamModel'] == 0) { ?>checked<?php  } ?> id="inlineRadio1" value="0"> 否     
											</label> 
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[teamModel]" <?php  if($activity['teamModel'] == 1) { ?>checked<?php  } ?> checked id="inlineRadio1" value="1"> 是      	
											</label> 
										...
										<div class="col-md-2 col-lg-5 font-set col-lg-offset-3 teamModelSet" style="margin-top:15px">
								          <div class="input-group"> 			
								            <div class="input-group-addon">1级转介绍比例&nbsp;&nbsp;&nbsp;&nbsp;</div>
								            <input disabled="true" type="number" name="orther[agent1]" class="form-control" value="">
								            <div class="input-group-addon">%&nbsp;</div> 	 	
								          </div>	 	 		 	 	
								          <div class="input-group"> 			
								            <div class="input-group-addon">2级转介绍比例&nbsp;&nbsp;&nbsp;&nbsp;</div>
								            <input disabled="true" type="number" name="orther[agent2]" class="form-control" value="">
								            <div class="input-group-addon">%&nbsp;</div>  		 			 	
								          </div> 		 	
								        </div> 			
								</div> 		 			
							...
							<div class="form-group">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<div class="col-sm-9 col-xs-12">
										<?php if( ce('activity.activity' ,$su_info) ) { ?>
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[isAudit]" <?php  if(empty($activity['isAudit'])) { ?>checked<?php  } ?> id="inlineRadio1" value="0"> 不需要审核     
											</label> 
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[isAudit]" <?php  if($activity['isAudit'] == 1) { ?>checked<?php  } ?> id="inlineRadio1" value="1"> 需要审核     
											</label> 
										<?php  } else { ?>
											<div class='form-control-static'>********</div>
										<?php  } ?>
							...
							<div class="form-group">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<div class="col-sm-9 col-xs-12">
										<?php if( ce('activity.activity' ,$su_info) ) { ?>
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[refund]" <?php  if($activity['refund'] == 0) { ?>checked<?php  } ?> id="inlineRadio1" value="0"> 不允许     
											</label> 
											<label class="radio-inline">
											  <input disabled="true" type="radio" name="orther[refund]" <?php  if($activity['refund'] == 1) { ?>checked<?php  } ?> id="inlineRadio1" value="1"> 允许     
											</label> 
										<?php  } else { ?>
											<div class='form-control-static'>********</div>
										<?php  } ?>
        ...
        <form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
            ...
            <div class="form-group row">	 	 	 	 
                ...
                <div class="col-xs-12 col-sm-4 col-lg-2 sx">
                    <div class="input-group">
                        ...
                        <select name='is_top' class='form-control'>	 	
                            <option value=''></option>	  	 		 	 	
                            <option value='1' <?php  if($_GPC['is_top']=='1') { ?>selected<?php  } ?>>优先</option>
                            <option value='2' <?php  if($_GPC['is_top']=='2') { ?>selected<?php  } ?>>王顶</option>
                            <option value='3' <?php  if($_GPC['is_top']=='3') { ?>selected<?php  } ?>>置顶</option>
                            <option value='4' <?php  if($_GPC['is_top']=='4') { ?>selected<?php  } ?>>刷新</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4 col-lg-4 sx">
	                ...
	                <div class="col-xs-12 col-sm-4 col-lg-4 sx" style="margin-top: 7.5px;">
	                    <div class="input-group">	 	 	 	
	                        <div class="input-group-addon">
	                        	开始时间
	                        	<label for="s1">
	                        		不搜索
		                       		<input type="radio" id="s1" name="searchtime" value="0">		 	 
	                        	</label>
	                        	<label for="s2">
	                        		搜索
		                       		<input type="radio" id="s2" name="searchtime" value="1">		 	 
	                        	</label>			 	 		 	 		 	 	
	                        </div>
	                       	<?php  echo tpl_form_field_daterange('time',array('start'=>$_GPC['time']['start'],'end'=>$_GPC['time']['end']),1)?>
	                    </div> 	 	 		 	 
	                </div>		  	 	 	 		 	 
	    	...
	    	<table class="table table-hover table-responsive">
	    		<thead class="navbar-inner">
	    			<tr>	 	 	
	    				...
	    				<th style="width:5%;">转发数</th>
	    				<th style="width:5%;">报名数</th>
	    				<th style="width:11%;">发布时间</th>	 
	    				<th style="width:11%;">开始时间</th>	 
	    				<th style="width:5%;">推广栏</th>
	    		...
	    		<tbody>	 	 	 	 	 			 
	    			<?php  if(is_array($list)) { foreach($list as $index => $item) { ?>	 	 	 
		    			<tr> 		 				 		  	 		 	  	 	 	
		    				...
		    				<td> 			 	 		
		    					<a class="mywidth" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'add','type'=>1,'id'=>$item['id']))?>">修改标题</a>|

		    					<a class="mywidth" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'add','type'=>2,'id'=>$item['id']))?>"> 修改正文</a>|

		    					<a class="mywidth preview" href="javascript:void(0);" data-id="<?php  echo $item['id'];?>">预览</a><br/> 

		    					<a class="mywidth" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'signup','id'=>$item['id']))?>">报名名单</a>|

		    					<a class="mywidth" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'signin','id'=>$item['id']))?>">签到名单</a>|

		    					<a class="mywidth" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'netmap','ac'=>'treeview','id'=>$item['id']))?>">报名网络图</a><br/>

		    					<a class="mywidth" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'refund','id'=>$item['id']))?>">退款信息</a>|	 	 
		    					...
		    					<a class="mywidth" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'add','id'=>$item['id'],'ac'=>'clone'))?>">复制活动</a>|
		    					...
		    					<a class="mywidth" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'live','id'=>$item['id']))?>">现场互动</a>|
...
<div id="modal-module-menusss" class="modal fade" tabindex="-1" aria-hidden="false" >
	<div class="modal-dialog" style="width: 650px;margin-top:2%;">
		<div class="modal-content">
			...
			<div class="modal-body"> 		 	
				<ul>
					<?php  if(is_array($sgPoster)) { foreach($sgPoster as $index => $item) { ?>
					<li class="poster pad" data-id="<?php  echo $item['id'];?>" <?php  if($index==0) { ?>style="margin-right:15px;"<?php  } ?>>
...
<script type="text/javascript">
	...
	function send(){ 
		...
		$.post('<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'preview'))?>',data,function(data){
			alert(data.result);
			if (data.status == 1) {
				$('[name="atid"]').val(null); 	 
	...
	function del(id){
		...
		$.post('<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'delete'))?>',data,function(data){
			alert(data.result);
			if (data.status == 1) { 	
				location.reload();
			} 
	...
	function notice(){
		...
		$.post('<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'notice'))?>',data,function(data){
			alert(data.result); 			 	 
			if (data.status == 1) { 		 		
				$('[name="atids"]').val(null); 	 	  			 	
	...
	function creatPoster(){
		...
		location.href="<?php  echo $this->createPluginMobileUrl('bartact/center',array('op'=>'poster','what'=>2))?>&act_id="+actid+'&poster_tpl='+posterid; 	  	 		 		  	 	
	} 		 		 	 	
	...
	function team(){
		...
		$.post('<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'team','id'=>$_GPC['id']))?>',function(data){
			alert(data.result); 	 	
			if (data.status == 1) {
	...
	$('.sgnotice').click(function(){
		...
		$.post('<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'getlist'))?>',data,function(data){
	...
	function sgnotice(){ 	
		...
		$.post('<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'sinotice','ac'=>'add'))?>',data,function(data){
			alert(data.result); 	 	
			if (data.status == 1) { 		
	...
	$('body').on('click','.sgdel',function(){
		...
		$.post('<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'sinotice','ac'=>'del'))?>',data,function(data){
			alert(data.result); 	 	
			if (data.status == 1) { 		
				$('#modal-module-notice-menus').modal('hide');
				setTimeout(function(){ 	  	 				 		 
...
<div class='panel panel-default' style="border-radius: 5px;">	 	 
	...
	<?php  if($_GPC['ac'] == 'netmap') { ?> 	 	 			 		 	 	 		 	 		 	 		 	
		<a class="btn btn-success" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'netmap','ac'=>'treeview','id'=>$_GPC['id']))?>">切换到树状图</a>	 
	<?php  } else { ?>	 		 	 	 			 	 	 			 	 			
		<a class="btn btn-warning" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'netmap','ac'=>'netmap','id'=>$_GPC['id']))?>">切换到网络图</a>
	<?php  } ?>	 		 	
	    <div class='panel-body'>
	    		...
	    		<tbody>
	    			<?php  if(is_array($list)) { foreach($list as $index => $item) { ?>
		    			<tr> 	 	  	 	 	
		    				...
		    				<td>
		    					<?php  if($item['status'] == 0) { ?>
		    						<a class="label label-success" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'audit','id'=>$item['id'],'type'=>1,'check'=>1))?>">通过</a>
		    						<a class="label label-danger" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'audit','id'=>$item['id'],'type'=>1,'check'=>2))?>">驳回</a>
		    					<?php  } ?>
		    				</td> 	 	 		 
		    			</tr>
	    			<?php  } } ?>
				...
				<div class="form-group">
					...
					<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
						<div class='input-group'>
							...
							<select name="status" class='form-control'> 
								...
								<option value="1" <?php  if($_GPC['status']== '1') { ?> selected<?php  } ?>>审核中</option>
								<option value="2" <?php  if($_GPC['status'] == '2') { ?> selected<?php  } ?>>通过</option>
								<option value="3" <?php  if($_GPC['status'] == '3') { ?> selected<?php  } ?>>驳回</option>
							</select> 	 		 
						</div>
					</div>
					...
					<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
						<div class='input-group'>	 	 	 
							...
							<select name="signin" class='form-control'> 
								<option value="" <?php  if($_GPC['signin'] == '') { ?> selected<?php  } ?>></option>
								<option value="1" <?php  if($_GPC['signin']== '1') { ?> selected<?php  } ?>>已签到</option>
								<option value="2" <?php  if($_GPC['signin'] == '2') { ?> selected<?php  } ?>>未签到</option>
							</select> 	 		 
						</div>
					</div>
					...
					<div class="col-lg-1 col-md-6 col-sm-6 col-xs-12">	 	 	 
						<div class='input-group'>	
							<button name="export" value="1" class="btn btn-default"><i class="fa fa-remove"></i>导出</button>
						</div>
					</div>
	    		...
	    		<tbody>
	    			<?php  if(is_array($list)) { foreach($list as $index => $item) { ?>
		    			<tr> 	 	  	 	 	 		 	
		    				...
		    				<td>
		    						<a class="label label-success" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'signup','ac'=>'audit','id'=>$item['id'],'type'=>1,'check'=>1))?>">通过</a>
		    						<a class="label label-danger" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'signup','ac'=>'audit','id'=>$item['id'],'type'=>1,'check'=>2))?>">驳回</a>
		    				</td> 	 	 		  	 	
		    			</tr>
	    			<?php  } } ?>
	    		</tbody>
							...
							<div class="form-group">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<div class="col-sm-9 col-xs-12"> 		  			
										<?php if( ce('activity.activity' ,$su_info) ) { ?> 	 	 	
											<label class="radio-inline"> 	 	 	 
											  <input type="radio" name="data[afterTheSignup]" <?php  if($act['afterTheSignup'] == 0) { ?>checked<?php  } ?> checked id="inlineRadio1" value="0"> 否    	   
											</label>  	 	
											<label class="radio-inline"> 	 	 		 
											  <input type="radio" name="data[afterTheSignup]" <?php  if($act['afterTheSignup'] == 1) { ?>checked<?php  } ?> id="inlineRadio1" value="1"> 是    	    
											</label> 	 	 
										<?php  } else { ?>
											<div class='form-control-static'>********</div>
										<?php  } ?>
...
<script language='javascript'>
   ...
   $(function(){
        ...
        $(':input[name=submit]').click(function(){
           ...
           <?php  if(empty($_GPC['id']) || $_GPC['type'] == 1) { ?>
...
//			<?php  } ?>
            ...
            $('#dataform').ajaxSubmit(function(data){
                ...
                if(data.status != 1){
                      ...
                      alert(data.result);	 	  		  		 
                      location.href='<?php  echo $this->createPluginWebUrl("bartact/activity")?>';
                }
            })
        })
