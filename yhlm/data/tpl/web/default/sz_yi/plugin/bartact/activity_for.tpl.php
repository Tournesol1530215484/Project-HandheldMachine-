...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <form action="./index.php" method="get" class="form-horizontal"  id="form1">
            ...
            <input type="hidden" name="method" value="activity_for" />
            ...
            <tbody>          
                ...
                <tr>         
                    ...
                    <td>  
                        ...
                        <a data-id="<?php  echo $row['id'];?>" class="label label-control label-success" href="<?php  echo $this->createPluginWebUrl('bartact/activity',array('op'=>'readonly','id'=>$row['id']))?>">查看详情</a>          
...
<div id="modal-module-menus"  class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header"><button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button><h3>查看活动</h3></div>
            <div class="modal-body" >
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label style="margin-top:8px;" class="col-xs-12 col-sm-3 control-label">活动编号</label>
                    ...
                    <div class="form-group">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label style="margin-top:8px;" class="col-xs-12 col-sm-3 control-label">活动名称</label>
                            <div class="col-sm-9 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label style="margin-top:8px;" class="col-xs-12 col-sm-3 control-label">活动描述</label>
                    ...
                    <div class="form-group">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label style="margin-top:8px;" class="col-xs-12 col-sm-3 control-label">活动标签</label>
                            <div class="col-sm-9 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label style="margin-top:8px;" class="col-xs-12 col-sm-3 control-label">活动主图</label>
                            <div class="col-sm-9 col-xs-12">
