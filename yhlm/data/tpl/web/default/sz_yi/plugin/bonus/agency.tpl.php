...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
            ...
            <input type="hidden" name="method" value="agency" />
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th style='width:10%;'>代理商工号</th>
                    <th style='width:10%;'>代理商姓名</th>
                    <th style='width:10%;'>代理商状态</th>
                ...
                <tr>
                    ...
                    <td><?php  echo $row['worknumber'];?></td>
                    <td><?php  echo $row['workname'];?></td>
                    <td><?php  if($row['workstatus'] == 1) { ?>
                            <label class="label label-success">正常</label>
                        <?php  } else { ?>
                            <label class="label label-wanrning">冻结</label>
                        <?php  } ?>
                    </td>
                    <td>
...
<tr class="aginput">
    <td><input type="text" name="agname" class="form-control"></td>
    <td><input type="text" name="agpwd" class="form-control"></td>
    <td><input type="text" name="agmobile" class="form-control"></td>
</tr>
</tbody>
</table>
