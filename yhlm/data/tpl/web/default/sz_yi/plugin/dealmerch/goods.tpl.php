        ...
        <div class="">
            ...
            <div class="">
                <div class="ulleft-nav">
                    <!-- <?php if(cv('dealmerch.goods.view')) { ?><li><a href="<?php  echo $this->createWebUrl('shop/goods')?>">商品管理</a></li><?php  } ?> -->
                ...
                <!--<div class="good-tit">
                    ...
                    <div class="col-sm-10 col-xs-12 text-right">
                        ...
                        <input type="button" name="back" onclick='history.back()' <?php if(cv('dealmerch.goods.add|dealmerch.goods.edit')) { ?>style='margin-left:10px;'<?php  } ?> value="返回列表" class="btn btn-default" />
                        <input type="hidden" name="token" value="<?php  echo $_W['token'];?>" />
                    </div>
                </div>-->
                <div class="tab-content " style="overflow:inherit">
                    <div class="tab-pane active" id="tab_basic" style="margin-top: -35px;">
                        <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('goods/basic', TEMPLATE_INCLUDEPATH)) : (include template('goods/basic', TEMPLATE_INCLUDEPATH));?>
                    ...
                    <div class="tab-pane" id="tab_special"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('goods/special', TEMPLATE_INCLUDEPATH)) : (include template('goods/special', TEMPLATE_INCLUDEPATH));?></div>
                    <div class="tab-pane" id="afterSalesServices"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('goods/afterSalesServices', TEMPLATE_INCLUDEPATH)) : (include template('goods/afterSalesServices', TEMPLATE_INCLUDEPATH));?></div>
                ...
                <div class="form-group col-sm-12 mrleft40 border-t">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">&nbsp;</label>
                    <?php  if(empty($_GPC['read'])) { ?>
                    <?php if( ce('dealmerch.goods' ,$item) ) { ?>
                ...
                <div class="form-group">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class='input-group'>
                            ...
                            <input type="hidden" name="uid" id="uid" value="<?php  if(!empty($selmerch)) { ?><?php  echo $selmerch['uid'];?><?php  } ?>">
                            </div>
                            </div>	 		 		 	 		 		 		 	 
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                        <div class='input-group'>
                            ...
                            <select name="status" class='form-control'>
                                ...
                                <option value="2" <?php  if($_GPC['status'] == '2') { ?> selected<?php  } ?>>等待上架</option>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <label data='<?php  echo $item['status'];?>' class='label  label-default <?php  if($item['status']==1) { ?>label-info<?php  } ?>' <?php if(cv('dealmerch.goods.edit')) { ?>onclick="setProperty(this,<?php  echo $item['id'];?>,'status')"<?php  } ?>><?php  if($item['status']==1) { ?>上架<?php  } else { ?>下架<?php  } ?></label>
                    ...
                    <td style="position:relative;" class="myown" id="something">
                        ...
                        <?php if(cv('dealmerch.goods.edit|dealmerch.goods.view')) { ?>
                        <a href="<?php  echo $this->createPluginWebUrl('dealmerch/goods', array('id' => $item['id'], 'op' => 'post'))?>"class="btn btn-sm btn-default" title="<?php if(cv('dealmerch.goods.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?>" style="background-color: #ff5858;"><i class="fa fa-pencil" style="color: #fff;"></i></a><?php  } ?>
                        ...
                        <?php if(cv('dealmerch.goods.delete')) { ?>
                        <a href="<?php  echo $this->createPluginWebUrl('dealmerch/goods', array('id' => $item['id'], 'op' => 'delete'))?>" onclick="return confirm('确认删除此商品？');return false;" class="btn btn-default  btn-sm" title="删除" style="background-color: #2d2d2d;"><i class="fa fa-times" style="color: #fff;"></i></a><?php  } ?>
                    </td>
                </tr>
                <?php  } } ?>
                <tr>
                    <td colspan='10'>
                        <?php if(cv('dealmerch.goods.edit')) { ?>
                        <input type="hidden" name="token" value="<?php  echo $_W['token'];?>" />
                        <?php  } ?>
                    </td>
                </tr>
