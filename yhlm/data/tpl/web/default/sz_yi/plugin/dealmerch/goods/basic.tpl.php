        ...
        <div class="form-group ">
            ...
            <div class="col-sm-9 col-md-8">
                ...
                <!--<label for="cbxLocaleFlag">包邮-->
                    ...
                    <!--<input type="checkbox" id="cbxFlag" name="cbxFlag" value="1">-->
                ...
                <div class="form-group addLocalFlag" style="display: none">
                    ...
                    <table class="table table-hover table-responsive" >
                        ...
                        <tr>
                            ...
                            [<button class="btn btn-default" type="button" onclick="popwin = $('#modal-module-menuss').modal();">选择兑换点</button>]
