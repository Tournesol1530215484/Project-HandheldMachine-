...
<div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="col-sm-10 col-lg-10 col-xs-10">
                            <input type="" name="adsn" value="<?php  echo $_GPC['adsn'];?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="col-sm-10 col-lg-10 col-xs-10">
                            <input type="" name="title" value="<?php  echo $_GPC['title'];?>" class="form-control">
                        </div>
                    </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">共计 <span style="color:red; "><?php  echo $totals;?></span> 条广告 </div>
        <div class="">
            <table class="table table-hover">
                ...
                <tr style="background: #eee">
                    <td><?php  echo $item['adsn'];?></td>
                    <td><?php  echo $item['username'];?></td>                
                    <td><?php  echo $item['mobile'];?></td>
                    <td><?php  echo $item['core'];?></td>
                    <td>         
                    ...
                    <td>
                        <?php  if($item['putInType'] == 1) { ?>
                             现金红包
                        <?php  } else if($item['putInType'] == 2) { ?>
                            易货码红包
                        <?php  } ?>
                    </td>
                    <td><?php  echo $item['receive'];?></td>
                    <td><?php  echo $item['got'];?></td>
                    <td><?php  echo $item['residual'];?></td>
                    <td><?php  echo date('Y-m-d',$item['stime'])?></td>
                    <td><?php  echo $item['calctime'];?></td>
                    <td><?php  echo date('Y-m-d',$item['etime'])?></td>
                    <td>
                        <label data-id="<?php  echo $item['id'];?>"  class="label label-success showmodal">查看</label>
                    </td>
                </tr>
                <?php  } } ?>
            </table>
