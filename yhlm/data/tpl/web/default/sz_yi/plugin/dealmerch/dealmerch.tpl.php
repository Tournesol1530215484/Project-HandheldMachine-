            ...
            <div class="form-group">				
                <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
	                ...
	                <div class="col-sm-8 col-lg-9 col-xs-12">
	                    <input type="text" class="form-control"  name="keyword" value="<?php  echo $_GPC['keyword'];?>" placeholder='姓名/手机号/微信名'/>                   
	                </div>                      
	            </div>     
...
<div class="panel panel-default">                   
	<div class="panel-body">
    	<a class='btn btn-default' style="background-color: #1E95C9; color: #fff; border-radius: 6px;" href="<?php  echo $this->createPluginWebUrl('dealmerch/dealmerch_add', array('op' => 'post'))?>">添加新换货商家</a>
	</div>
</div>
<div class="panel panel-default">        
    <div class="panel-heading" style="padding-bottom:36px;">
    <label class="col-xs-12 col-sm-3 col-md-3 control-label">总数 ： <?php  echo $total;?> </label>
    <label class="col-xs-12 col-sm-3 col-md-3 control-label">换货码总额 : <?php  echo $currency['credit3'];?></label>
    <label class="col-xs-12 col-sm-3 col-md-2 control-label">余额总额 : <?php  echo $currency['credit2'];?></label>
    <label class="col-xs-12 col-sm-3 col-md-2 control-label">换货额度总额 : <?php  echo $currency['currency_credit3'];?> </label>
    </div>                  
    <div class="">                                  
        <table class="table table-hover table-responsive">
            <thead class="navbar-inner" >        
                <tr><th style="width:auto;">商家ID</th>
                    <th style="width:auto;">用户名</th>
                    <th style="width:auto;">姓名</th>     
                    <th style="width:auto;">手机号码</th>
                    <th style="width:auto;">换货码余额</th>       
                ...
                <?php  if(is_array($list)) { foreach($list as $row) { ?>
                	<?php  if(!empty($row['uid'])) { ?>
		                <tr><td><?php  echo $row['uid'];?></td>
		                    <td><a href="<?php  echo $this->createPluginWebUrl('dealmerch/dealmerch/detail',array('uid' => $row['uid']));?>" title='商家信息' style="color: #0060DF;"><?php  echo $row['username'];?></a></td>
		                    <td><?php  echo $row['realname'];?></td>        
		                    <td><?php  echo $row['mobile'];?></td>
		                    <td><?php  echo $row['credit3'];?></td>               
                                ...
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="javascript:;">操作 <span class="caret"></span></a>
                                        <ul class="dropdown-menu dropdown-menu-left" role="menu" style='z-index: 99999'>
                                            ...
                                            <li><a href="<?php  echo $this->createWebUrl('finance/recharge', array('op'=>'credit3','id'=>$row['mid']))?>" title='充值换货码'><i class='fa fa-yen'></i> 充值换货码 </a></li>
                                            <li><a href="<?php  echo $this->createWebUrl('finance/recharge', array('op'=>'currency_credit3','id'=>$row['mid']))?>" title='充值换货额'><i class='fa fa-yen'></i> 充值换货额度 </a></li>
...
<form <?php if(cv('dealmerch.dealmerch.edit')) { ?>action="" method='post'<?php  } ?> class='form-horizontal'>
    <input type="hidden" name="id" value="<?php  echo $dealmerchinfo['uid'];?>">
        ...
        <div class='panel-body'>
            ...
            <div class="form-group">                
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="col-sm-9 col-xs-12">
                           <?php if(cv('dealmerch.dealmerch.edit')) { ?>
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                         <?php if(cv('dealmerch.dealmerch.edit')) { ?>
                            ...
                            <input type="hidden" name="token" value="<?php  echo $_W['token'];?>" />
                        <?php  } ?>
                       <input type="button" name="back" onclick='history.back()' <?php if(cv('dealmerch.dealmerch.edit')) { ?>style='margin-left:10px;'<?php  } ?> value="返回列表" class="btn btn-default" />      
                    </div>
            </div>
         </div>
    </div>
