...
<?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('dealorder/tabs', TEMPLATE_INCLUDEPATH)) : (include template('dealorder/tabs', TEMPLATE_INCLUDEPATH));?>
<style type='text/css'>
  ...
  <tr class='trbody'>
    ...
    <td  rowspan="<?php  echo count($item['goods'])?>" style='width:18%;'><table style='width:100%;'>
        <tr>
          ...
          <td  style='border:none;text-align:right;;'><?php  echo number_format( $item['goodsprice'] ,2)?> 换货码</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <!--<td  style='border:none;text-align:right;color:green;'>￥<?php  echo number_format($item['price'],2)?></td>-->
            <td  style='border:none;text-align:right;'><?php  echo number_format( $item['goodsprice'] ,1)?>换货码 <?php  if($item['olddispatchprice']>0 ) { ?>+<?php  echo number_format( $item['olddispatchprice'],1)?><?php  } ?></td>
        </tr>
    ...
    <td   rowspan="<?php  echo count($item['goods'])?>" ><label class='label label-<?php  echo $item['statuscss'];?>'><?php  echo $item['status'];?></label>
      <br />
      <a href="<?php  echo  $this->createPluginWebUrl('suppliermenu/'.$_GPC['method'], array('op' => 'detail', 'id' => $item['id']))?>"   >查看详情</a></td>
    <td   rowspan="<?php  echo count($item['goods'])?>" width="10%"> <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('dealorder/ops', TEMPLATE_INCLUDEPATH)) : (include template('dealorder/ops', TEMPLATE_INCLUDEPATH));?> </td>
    <?php  } ?> </tr>
  <?php  } } ?>
</table>
<?php  } } ?>
  ...
  <div class="panel-body">
    <table class="table table-hover table-responsive">
      <thead class="navbar-inner" >
        <tr>
          <th style='width:auto;'>供应商ID</th>
          <th style='width:auto;'>提现单号</th>
          <th style='width:auto;'>开户名</th>
          <th style='width:auto;'>电话</th>
          <th style='width:auto;'>开户银行</th>
          <th style='width:auto;'>银行卡号</th>
          <th style='width:auto;'>提现金额</th>
          <th style='width:auto;'>提现手续费</th>
          <th style='width:auto;'>提现方式</th>
      ...
      <tbody>
          ...
          <th style='width:8%;'>提现手续费</th>
          <th style='width:6%;'>提现方式</th>
      ...
      <tr>
        ...
        <td><?php  echo $row['apply_deduct'];?></td>
        <td>
            <?php  if($row['type']==1) { ?>
        ...
        <td  style="overflow:visible;"><div class="form-group">
            <div class="col-sm-9 col-xs-9">
              <span style='color:blue'>申请中</span>
            </div>
          </div>
        </td>
        <?php  } else { ?>
...
<?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('dealorder/modals', TEMPLATE_INCLUDEPATH)) : (include template('dealorder/modals', TEMPLATE_INCLUDEPATH));?>
          <?php  if(p('commission')) { ?>

           <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('dealorder/changecommission', TEMPLATE_INCLUDEPATH)) : (include template('dealorder/changecommission', TEMPLATE_INCLUDEPATH));?>
          <?php  } ?>
