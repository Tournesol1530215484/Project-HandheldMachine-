        ...
        <table class="table table-hover">
            <thead class="navbar-inner">
                <tr>
                    ...
                    <th style='width:10%;'><?php  if($_GPC['type']==1) { ?>申请提现金额<?php  } else { ?>充值金额<?php  } ?></th>
                ...
                <tr>
                    ...
                    <td><?php if(cv('member.member.view')) { ?>
                        ...
                        <?php if(cv('finance.withdraw.withdraw')) { ?>
	                        <a class='btn btn-default' onclick="return confirm('确认微信钱包提现?')" href="<?php  echo $this->createWebUrl('finance/log',array('op'=>'pay','paytype'=>'wechat','id' => $row['id']));?>" style="background-color: #ffb034; color:#fff;">微信提现</a><br />	
	                        <a class='btn btn-default' onclick="return confirm('确认手动提现完成?')" href="<?php  echo $this->createWebUrl('finance/log',array('op'=>'pay','paytype'=>'manual','id' => $row['id']));?>" style=" margin-top: 6px; background-color: #ff5858; color:#fff;">手动提现</a><br />
	                        <a class='btn btn-default' onclick="return confirm('确认拒绝提现申请?')" href="<?php  echo $this->createWebUrl('finance/log',array('op'=>'pay','paytype'=>'refuse','id' => $row['id']));?>" style=" margin-top: 6px; background-color: #000; color:#fff;">拒绝</a><br />
                        <?php  } ?>
                        <?php  } ?>
                    </td>
                </tr>
