					...
					<div class="form-group">
						...
						<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
							<select class="form-control" name="express" id="express">
								...
								<option value="shunfeng" data-name="顺丰速运">顺丰</option>
								<option value="shentong" data-name="申通快递">申通</option>
								...
								<option value="zhongtong" data-name="中通快递">中通速递</option>
								<option value="ems" data-name="EMS">ems快递</option>
								...
								<option value="debangwuliu" data-name="德邦快递">德邦物流</option>
...
<div id="modal-cancelsend" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="width:600px;margin:0px auto;">
	<form class="form-horizontal form" action="<?php  echo $this->createWebUrl('order')?>" method="post" enctype="multipart/form-data">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button aria-hidden="true" data-dismiss="modal" class="close disbut" type="button">×</button>
					<h3>取消发货</h3>
				</div>
				<div class="modal-body">
					<label>取消发货原因</label>
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
							...
							<label class='radio-inline'>
								<input type='radio' value='1' name='refundstatus'>同意退款
							</label>
							<label class='radio-inline'>
