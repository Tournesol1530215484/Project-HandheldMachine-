                ...
                <div class="form-group">
	                ...
	                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="col-sm-9 col-xs-12">
                          ...
                          <?php  } else { ?>
                          <div class='form-control-static'>
                             <?php  if(empty($level['discount'])) { ?>不打折
                             <?php  } else { ?>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <div class='input-group'>
                            ...
                            <input type="text" name="descscale" class="form-control" value="<?php  echo $level['descscale'];?>" />
...
<form action="" method="post" onsubmit="return formcheck(this)">
     <div class='panel panel-default'>
        ...
        <tr>
          ...
          <td><?php  if($row['commission_level_id']) { ?><?php  echo $row['commission_level_id'];?><?php  } else { ?>-<?php  } ?></td>
          <td><?php  echo $row['level'];?></td>
          <td><?php  echo $row['levelname'];?></td>
          <td><?php  if(empty($shopset['leveltype'])) { ?>
            ...
            <?php  } ?>
            <?php  } ?> </td>
            <td><?php  echo $row['descscale'];?>%</td>
          <td> <?php if(cv('member.level.add|member.group.view')) { ?> <a class='btn btn-default' href="<?php  echo $this->createWebUrl('member/level', array('op' => 'post', 'id' => $row['id']))?>" title="<?php if(cv('member.level.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>"><i class='fa fa-edit'></i></a> <?php  } ?>
            <?php if(cv('member.level.delete')) { ?> <a class='btn btn-default'  href="<?php  echo $this->createWebUrl('member/level', array('op' => 'delete', 'id' => $row['id']))?>" onclick="return confirm('确认删除此等级吗？');return false;"><i class='fa fa-remove'></i></a></td>
          <?php  } ?> </tr>
        <?php  } } ?>
