				...
				<div class="">
					<div class="form-group">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label class="col-xs-12 col-sm-3 col-md-3 control-label">微站名称</label>
							<div class="col-sm-9 col-xs-12">
								<input type="text" name="title" class="form-control" value="<?php  echo $multi['title'];?>" />
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label class="col-xs-12 col-sm-3 col-md-3 control-label">触发关键字</label>
							<div class="col-sm-9 col-xs-12">
					...
					<div class="form-group">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label class="col-xs-12 col-sm-3 col-md-3 control-label">是否启用</label>
							<div class="col-sm-9 col-xs-12">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label class="col-xs-12 col-sm-3 col-md-3 control-label">选择微站风格</label>
							<div class="col-sm-9 col-xs-12">
					...
					<div class="form-group">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<label class="col-xs-12 col-sm-3 col-md-3 control-label">页面描述</label>
							<div class="col-sm-9 col-xs-12">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label class="col-xs-12 col-sm-3 col-md-3 control-label">绑定域名</label>
							<div class="col-sm-9 col-xs-12">
					...
					<div class="form-group">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label class="col-xs-12 col-sm-3 col-md-3 control-label">封面</label>
							<div class="col-sm-9 col-xs-12">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label class="col-xs-12 col-sm-3 col-md-3 control-label">底部自定义</label>
							<div class="col-sm-9 col-xs-12">
					...
					<div class="form-group">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="preview-style" <?php  if(empty($multi['style']['tname'])) { ?>style="display:none;"<?php  } ?>>
							<label class="col-xs-12 col-sm-4 col-md-3 col-lg-3 control-label">当前微站风格</label>
...
<style type="text/css">
	.manage_menu a{ color: #fff; display: inline-block; padding: 2px 5px; background-color: #428BCA; border-radius: 2px; }
</style>
<ul class="nav nav-tabs">
...
<div class="clearfix template">
	<div class="panel panel-default">
		<div class="panel-heading">可用的微站</div>
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr><td style="vertical-align:middle;"><?php  echo $item['title'];?><?php  if($default_site == $item['id']) { ?><br /><span class="label label-success" style="display: table-caption;margin-top: 2px; padding: .3em .6em .3em;">默认微站</span><?php  } ?></td>
						...
						<td class="manage-menu manage_menu" style="position:relative;">
							<a href="<?php  echo url('site/multi/post', array('multiid' => $item['id']))?>" style="margin-bottom: 10px;">编辑</a>
							<a href="<?php  echo url('site/slide/display', array('multiid' => $item['id']))?>">幻灯片</a>
							<a href="<?php  echo url('site/nav/home', array('multiid' => $item['id'], 'f' => 'multi'))?>">导航菜单</a><br />
							<a href="<?php  echo url('site/editor/quickmenu', array('multiid' => $item['id'], 'type' => '2'))?>">快捷菜单</a>
							<span><a class="js-clip" href="javascript:;" data-url="<?php  echo murl('home', array('t' => $item['id']), true, true)?>" style="background-color: #99C514;">复制链接</a></span>
							<a href="<?php  echo url('site/multi/copy', array('multiid' => $item['id']))?>" style="background-color:#5cb85c;">复制站点</a>
