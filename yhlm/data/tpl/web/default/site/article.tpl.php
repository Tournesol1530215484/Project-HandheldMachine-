			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:right; position:relative;">
						...
						<a href="<?php  echo url('site/article/post', array('id' => $item['id']))?>" title="编辑">编辑</a>&nbsp;-&nbsp;
						<a onclick="return confirm('此操作不可恢复，确认吗？'); return false;" href="<?php  echo url('site/article/delete', array('id' => $item['id']))?>" title="删除">删除</a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
...
<?php  } else if($do == 'post') { ?><style type="text/css">
...
<form class="form-horizontal form" action="" method="post" enctype="multipart/form-data">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="col-sm-8 col-xs-12">
							...
							<div class="help-block">
								<label class="checkbox-inline"><input type="checkbox" name="autolitpic" value="1"<?php  if(empty($item['thumb'])) { ?> checked="true"<?php  } ?>>提取内容的第一个图片为缩略图</label>
							</div>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-3 col-lg-1 control-label">内容</label>
	...
	<div class="form-group">		<label class="col-xs-12 col-sm-4 col-md-3 col-lg-2 control-label"></label>
		<div class="col-sm-8">
