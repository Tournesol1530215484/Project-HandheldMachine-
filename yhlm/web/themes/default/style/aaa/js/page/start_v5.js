var Page = {
    ...
    bindQQOnline: function() {
        ...
        $("#dailiFloatTrigger").bind("click",
        function() {
            if ($("#online_daili_layer").attr("show")) {
                $("#online_daili_layer").animate({
                    right: "-140px"
                },
                function() {
                    $(this).css("z-index", "20")
                });
                $("#online_daili_layer").removeAttr("show")
            } else {
                $("#online_daili_layer").animate({
                    right: "0px"
                }).css("z-index", "120");
                $("#online_daili_layer").attr("show", "1")
            }
        });
        $("#online_qq_layer").animate({
            right: "-140px"
        ...
        $(document).bind("click",
        function(a) {
            if (!$(a.target).isChildOf("#online_qq_layer") && !$(a.target).isChildOf("#online_daili_layer")) {
                $("#online_qq_layer").animate({
                    right: "-140px"
                },
                function() {
    ...
    bindItem1: function() {
        ...
        var b = $("<img id='bg' src='./themes/hc_style1/style/aaa/image/start/v5/bg" + c + ".jpg' />");
        ...
        $(".w-user input[name='username'],.w-user input[name='password']").on("keyup",
        function() {
            if ($(this).val() == "") {
                $(this).prev().show()
            } else {
        ...
        $("#signin-btn").click(function(h) {
            ...
            $.post("/memberajax.php?act=login&", f,
            function(i) {
                if (i.success == true) {
    ...
    bindNav: function() {
        ...
        $(".nav").click(function() {
            ...
            if (d == 0) {
                ...
                if (d == 1 && b.find("embed").size() == 0) {
                    b.find(".banner").html('<embed src="#http://player.youku.com/player.php/sid/XNjU5MTMyMzU2/v.swf" allowFullScreen="true" quality="high" width="960" height="100%" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed>')
                }
            }
