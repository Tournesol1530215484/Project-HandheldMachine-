<?php /*a:5:{s:72:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\index\MemberStatic.html";i:1589350845;s:67:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\header.html";i:1586589054;s:65:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\left.html";i:1589420850;s:66:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\right.html";i:1586589152;s:67:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\footer.html";i:1586589186;}*/ ?>
<!-- 顶部开始 -->
<!--头部开始-->
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5" action="<?php echo url('index/MemberSeacher'); ?>" method="get">
                        ...
                        <div class="layui-inline layui-show-xs-block">
                            <button class="layui-btn"  lay-submit="" lay-filter="print" ><i class="layui-icon"><a href="<?php echo url('index/MemberSeacher',array('satus'=>'print')); ?>">Excel打印</a></i></button>
                        </div>
                    </form>
                </div>
                ...
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table class="layui-table layui-form">
                        ...
                        <tbody>
                        <?php if($Allmembers){if(is_array($Allmembers) || $Allmembers instanceof \think\Collection || $Allmembers instanceof \think\Paginator): $i = 0; $__LIST__ = $Allmembers;if( count($__LIST__)==0 ) : echo "没有数据" ;else: foreach($__LIST__ as $key=>$AllMebersRes): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td>
                                <input type="checkbox" name="id" value="<?php echo htmlentities($AllMebersRes['id']); ?>"   lay-skin="primary">
                            </td>
                            <td><?php echo htmlentities($AllMebersRes['id']); ?></td>
                            <td><?php echo htmlentities($AllMebersRes['nickname']); ?></td>
                            <td>男</td>
                            <td><?php echo htmlentities($AllMebersRes['mobile']); ?></td>
                            <td><?php echo htmlentities($AllMebersRes['province']); ?> &nbsp; <?php echo htmlentities($AllMebersRes['city']); ?></td>
                            <td class="td-status">
                                <?php if(($AllMebersRes['status']==1)): ?>
                                <span class="layui-btn layui-btn-normal layui-btn-mini">
                                    <a onclick="member_stop(this,'<?php echo htmlentities($AllMebersRes['id']); ?>','<?php echo htmlentities($AllMebersRes['status']); ?>')" href="javascript:;"  title="已启用">已启用</a>
                                </span>
                                <?php else: ?>
                                <span class="layui-btn layui-btn-normal layui-btn-mini layui-btn-danger">
                                    <a onclick="member_stop(this,'<?php echo htmlentities($AllMebersRes['id']); ?>','<?php echo htmlentities($AllMebersRes['status']); ?>')" href="javascript:;"  title="以停用">以停用</a>
                                </span>
                                <?php endif; ?>
                            </td>
                            <td class="td-manage">
                                <a title="编辑" onclick="edit_info(this,'<?php echo htmlentities($AllMebersRes['id']); ?>')" href="javascript:;">
                        ...
                        <?php endforeach; endif; else: echo "没有数据" ;endif; }else{?>
                            <tr>
                                暂无数据
                            </tr>
                        <?php }?>
...
<script>
    ...
    function member_stop(obj,id,status){
        layer.confirm('确认要停(启)用户吗？',function(index){
            $.ajax({
                url:"<?php echo url('index/MemberEdit'); ?>",
    ...
    function edit_info(obj,id){
        ...
        var index=layer.open({
            ...
            zindex: 198611140,
            area: ['40%', '60%'],
            content:"<?php echo url('index/MemberEdits'); ?>"+'?id='+id
        });
        // layer.open(index)
    }
    ...
    function member_del(obj,id){
        ...
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据
            $.ajax({
                url: "<?php echo url('index/MemberDel'); ?>",
