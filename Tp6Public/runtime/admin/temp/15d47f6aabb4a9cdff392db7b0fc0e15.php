<?php /*a:5:{s:69:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\admin\Adminrole.html";i:1589419774;s:67:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\header.html";i:1586589054;s:65:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\left.html";i:1589420850;s:66:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\right.html";i:1586589152;s:67:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\footer.html";i:1586589186;}*/ ?>
<!-- 顶部开始 -->
<!--头部开始-->
<!doctype html>
...
<!--                                  <th>拥有权限规则</th>-->
                              ...
                              <tbody>
                                <?php if(is_array($Group) || $Group instanceof \think\Collection || $Group instanceof \think\Paginator): $i = 0; $__LIST__ = $Group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$GroupRes): $mod = ($i % 2 );++$i;?>
                                <tr>
                                  <td>
<!--                                      <input type="checkbox" lay-filter="checkall" name="" lay-skin="primary">-->
                                      <input type="checkbox" name="id" value="<?php echo htmlentities($GroupRes['id']); ?>"   lay-skin="primary">
                                  </td>
                                  <td><?php echo htmlentities($GroupRes['id']); ?></td>
                                  <td><?php echo htmlentities($GroupRes['title']); ?></td>
<!--                                  <td>会员列表，问题列表</td>-->
                                  <td><?php echo htmlentities($GroupRes['desc']); ?></td>
                                  <td class="td-status">
                                      <?php if(($GroupRes['status']==1)): ?>
                                      <span class="layui-btn layui-btn-normal layui-btn-mini">
                                    <a onclick="member_stop(this,'<?php echo htmlentities($GroupRes['id']); ?>','<?php echo htmlentities($GroupRes['status']); ?>')" href="javascript:;"  title="已启用">已启用</a>
                                        </span>
                                      <?php else: ?>
                                      <span class="layui-btn layui-btn-normal layui-btn-mini layui-btn-danger">
                                    <a onclick="member_stop(this,'<?php echo htmlentities($GroupRes['id']); ?>','<?php echo htmlentities($GroupRes['status']); ?>')" href="javascript:;"  title="以停用">以停用</a>
                                </span>
                                      <?php endif; ?>
                                  <td class="td-manage">
...
<!--                                    </a>-->
                                    <a title="编辑"  onclick="role_info_edit(this,'<?php echo htmlentities($GroupRes['id']); ?>')" href="javascript:;">
                                      <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a title="删除" onclick="member_del(this,'<?php echo htmlentities($GroupRes['id']); ?>')" href="javascript:;">
                                      <i class="layui-icon">&#xe640;</i>
                                    </a>
                                  </td>
                                </tr>
    ...
    <script>
      ...
      function role_info(obj){
          var index=layer.open({
              ...
              zindex: 198611140,
              area: ['40%', '60%'],
              content:"<?php echo url('Admin/Adminrole'); ?>"+'?action='+'adminroleadd',
          });
      ...
      function role_info_edit(obj,id) {
          var index=layer.open({
              ...
              zindex: 198611140,
              area: ['40%', '60%'],
              content:"<?php echo url('Admin/Adminrole'); ?>"+'?action='+'rol_edit'+'&&id='+id,
          });
      }
