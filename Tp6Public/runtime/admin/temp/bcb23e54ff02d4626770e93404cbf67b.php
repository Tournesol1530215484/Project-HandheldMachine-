<?php /*a:5:{s:69:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\admin\Admincate.html";i:1589178673;s:67:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\header.html";i:1586589054;s:65:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\left.html";i:1589420850;s:66:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\right.html";i:1586589152;s:67:"E:\phpstudy\PHPTutorial\WWW\Tp6Public\view\admin\common\footer.html";i:1586589186;}*/ ?>
<!-- 顶部开始 -->
<!--头部开始-->
<!doctype html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" action="<?php echo url('Admin/AdminCate'); ?>">
<!--                                <?php echo url('Admin/AdminCate'); ?>-->
                        ...
                        <div class="layui-card-body ">
                            <table class="layui-table layui-form">
                                ...
                                <?php if(is_array($Cate) || $Cate instanceof \think\Collection || $Cate instanceof \think\Paginator): $i = 0; $__LIST__ = $Cate;if( count($__LIST__)==0 ) : echo "没有数据" ;else: foreach($__LIST__ as $key=>$CateRes): $mod = ($i % 2 );++$i;?>
                                  <tr>
                                      <td>
                                          <input type="checkbox" name="id" value="<?php echo htmlentities($CateRes['id']); ?>"   lay-skin="primary">
                                      </td>
                                    <td><?php echo htmlentities($CateRes['id']); ?></td>
                                    <td><?php echo htmlentities($CateRes['catename']); ?></td>
                                    <td class="td-manage">
                                      <a title="编辑" onclick="role_info(<?php echo htmlentities($CateRes['id']); ?>)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a>
                                      <a title="删除" onclick="member_del(this,<?php echo htmlentities($CateRes['id']); ?>)" href="javascript:;">
                                        <i class="layui-icon">&#xe640;</i>
                                      </a>
                                    </td>
                                  </tr>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              $.ajax({
                  url: "<?php echo url('Admin/Admincate'); ?>",
      ...
      function delAll (argument) {
        ...
        function role_info(id){
            var index=layer.open({
                ...
                zindex: 198611140,
                area: ['40%', '60%'],
                content:"<?php echo url('Admin/Admincate'); ?>"+'?id='+id+'&&action='+'admincateedit'
